...
elseif ($lista == "replanificar") {
	$titulo = "Replanificar Actuaciones Fiscales";
	$btNuevo = "display:none;";
	$btModificar = "display:none;";
	$btRevisar = "display:none;";
	$btGenerar = "display:none;";
	...
	if($_SESSION['permisos']['01-0004'] != 'S'){
		$btReplanificar = "display:none;";
	}
...
if ($filtrar == "default") {
	...
	elseif ($lista == "replanificar") $fedoreg = "AP";
}
...
<center>
<table width="1050" class="tblBotones" border="0">
	<tr>
		...
		<td align="right" nowrap="nowrap">
			...
			<input type="button" id="btReplanificar" value="Replanificar" style="width:75px; <?=$btReplanificar?>" onclick="cargarOpcion2(this.form, 'gehen.php?anz=pf_actuacion_fiscal_form&opcion=replanificar&action=pf_actuacion_fiscal_lista', 'SELF', '', $('#registro').val());" />
