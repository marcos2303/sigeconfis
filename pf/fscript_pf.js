...
function pdf_actuacion_fiscal(form, pdf) {
	...
	if (factuacion == ""){
		alert("¡ERROR: Debe seleccionar una actuación!");
	}else {
		if (fproceso == "01") {
			if (pdf == "planificacion")
				window.open("pf_pdf_actuacion_fiscal.php?forganismo="+forganismo+"&fregistrod="+fregistrod+"&fregistroh="+fregistroh+"&fedoreg="+fedoreg+"&fproceso="+fproceso+"&codigo="+factuacion, '', 'toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes');
			else if (pdf == "ejecucion")
				window.open("pf_pdf_actuacion_fiscal_ejecucion.php?forganismo="+forganismo+"&fregistrod="+fregistrod+"&fregistroh="+fregistroh+"&fedoreg="+fedoreg+"&fproceso="+fproceso+"&codigo="+factuacion, '', 'toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes');
		}
		else if (fproceso == "02") {
			if (pdf == "planificacion")
				window.open("pf_pdf_potestad_investigativa.php?forganismo="+forganismo+"&fregistrod="+fregistrod+"&fregistroh="+fregistroh+"&fedoreg="+fedoreg+"&fproceso="+fproceso+"&codigo="+factuacion, '', 'toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes');
			else if (pdf == "ejecucion")
				window.open("pf_pdf_potestad_investigativa_ejecucion.php?forganismo="+forganismo+"&fregistrod="+fregistrod+"&fregistroh="+fregistroh+"&fedoreg="+fedoreg+"&fproceso="+fproceso+"&codigo="+factuacion, '', 'toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes');
		}
		else if (fproceso == "03") {
			if (pdf == "planificacion")
				window.open("pf_pdf_determinacion_responsabilidades.php?forganismo="+forganismo+"&fregistrod="+fregistrod+"&fregistroh="+fregistroh+"&fedoreg="+fedoreg+"&fproceso="+fproceso+"&codigo="+factuacion, '', 'toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes');
			else if (pdf == "ejecucion")
				window.open("pf_pdf_determinacion_responsabilidades_ejecucion.php?forganismo="+forganismo+"&fregistrod="+fregistrod+"&fregistroh="+fregistroh+"&fedoreg="+fedoreg+"&fproceso="+fproceso+"&codigo="+factuacion, '', 'toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes');
		}
	}
	return false;
}
