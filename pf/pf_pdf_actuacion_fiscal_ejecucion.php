...
$pdf->Row(array('',
				...
				'Planificado',
				'Real'));
$pdf->SetWidths(array(7, 86, 10, 18, 18, 10, 18, 18, 10,10));
...
//echo $field_actividades['FechaInicio'];die;
	...
	if($field_actividades['Estado'] == "TE"){
		$diasret = getDiasHabiles($field_actividades['FechaTermino'], $field_actividades['FechaRegistroCierre']);	
		$diasret = $diasret;
		
	}elseif($field_actividades['Estado'] == "EJ"){
		$diasret = getDiasHabiles($field_actividades['FechaTerminoReal'], date('Y-m-d'));	
