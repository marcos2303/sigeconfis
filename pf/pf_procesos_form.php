...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=pf_procesos_lista" method="POST" onsubmit="return procesos(this, '<?=@$accion?>');">
...
<table width="600" class="tblForm">
	<tr>
		<td class="tagForm" width="125">* Proceso:</td>
		<td>
        	<input type="text" id="CodProceso" style="width:35px; font-weight:bold; font-size:12px;" value="<?=@$field_procesos['CodProceso']?>" disabled="disabled" />
		</td>
	</tr>
	<tr>
