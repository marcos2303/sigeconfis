...
<table width="1000" class="tblFiltro">
	<tr>
		...
		<td>
			<input type="checkbox" name="chkorganismo" id="chkorganismo" value="1" <?=@$corganismo?> onclick="chkFiltro_2(this.checked, 'chkorganismo', 'forganismo');" />
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="chkdependencia" id="chkdependencia" value="1" <?=@$cdependencia?> onclick="chkFiltro_2(this.checked, 'chkdependencia', 'fdependencia');" />
		...
		<td valign="top">
            <input type="checkbox" name="chkedoreg" id="chkedoreg" value="1" <?=@$cedoreg?> onclick="chkFiltro_2(this.checked, 'chkedoreg', 'fedoreg');"/>
    ...
    while ($field = mysql_fetch_array($query)) {
		...
		if (@$ventana == "setActuacionActividades") {
			...
			<tr class="trListaBody" onclick="mClk(this, 'registro'); setActuacionActividades('<?=$field['CodActuacion']?>', '<?=htmlentities($field['ObjetivoGeneral'])?>');" id="<?=$field['CodActuacion']?>">
                ...
                <td><?=utf8_encode($field['NomOrganismoExterno'])?></td>
                <td><?=utf8_encode($field['NomDependenciaExterna'])?></td>
                <td><?=utf8_encode($field['ObjetivoGeneral'])?></td>
