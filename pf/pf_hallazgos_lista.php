...
if ($lista == "todos") {
	$titulo = "Agregar cédula de hallazgos";
...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=pf_hallazgos_lista" method="post">
...
<table width="1050" class="tblBotones">
	<tr>
		...
		<td align="right">
			<input type="button" id="btAgregar" value="Agregar" style="width:75px; <?=$btVer?>" onclick="cargarOpcion2(this.form, 'pf_hallazgos_controller.php?action=nuevo', 'BLANK', 'height=700, width=900, left=100, top=0, resizable=no', $('#registro').val());" /> | 
			<input type="button" id="btListar" value="Listar" style="width:75px;" onclick="cargarOpcion2(this.form, 'pf_hallazgos_controller.php?action=list', 'BLANK', 'height=700, width=900, left=100, top=0, resizable=no', $('#registro').val());" /> | 
		</td>
	</tr>
</table>
