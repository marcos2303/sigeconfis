...
<form name="frmentrada" id="frmentrada" method="post" action="pf_pdf_actuacion_fiscal.php" onsubmit="return pdf_actuacion_fiscal(this, '<?=@$pdf?>');">
    <input type="text" name="concepto" value="<?php if(isset($_REQUEST['concepto']) and $_REQUEST['concepto']!='') echo $_REQUEST['concepto'];?>"/> 
...
<table width="1000" class="tblFiltro">
	...
	<tr>
		...
		<td>
            ...
            <input type="text" id="factuacion" style="width:100px;" name="factuacion"/>
	...
	<tr style="display: none;">
		...
		<td colspan="3">
			...
			<input  name="fproceso" id="fproceso" type="text" value="<?php echo $fproceso;?>"</input>
		</td>
	</tr>
</table>
</div>
