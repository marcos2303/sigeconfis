...
function Cabecera($pdf, $head, $fperiodo) {
	...
	$pdf->Cell(260, 4, ('CONTRALORIA DEL ESTADO DELTA AMACURO'), 0, 1, 'L');
...
while ($field_empleado = mysql_fetch_array($query_empleado)) {
	...
	$pdf->Cell(65, 3, ('LICDA. CARMEN ALFONZO'), 0, 0, 'L');
	$pdf->Cell(65, 3, ('LICDA. ROSIS REQUENA'), 0, 0, 'L');
	$pdf->Cell(70, 3, ('LICDA. YOSMAR GREHAM'), 0, 0, 'L');
	$pdf->Cell(70, 3, ('ABOG. MAGALYS BARRIOS'), 0, 1, 'L');
	
	$pdf->Cell(65, 3, ('ANALISTA RR.HH II'), 0, 0, 'L');
	$pdf->Cell(65, 3, ('DIRECTORA RECURSOS HUMANOS'), 0, 0, 'L');
	$pdf->Cell(70, 3, ('DIRECTORA ADMINISTRACION Y SERVICIOS.'), 0, 0, 'L');
	$pdf->Cell(70, 3, ('CONTRALORA (P)'), 0, 1, 'L');
}
