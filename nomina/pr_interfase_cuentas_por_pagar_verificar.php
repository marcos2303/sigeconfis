...
<table class="tblLista" width="100%">
    ...
    <?php
	//	presupuesto
	$sql = "SELECT CodPresupuesto FROM pv_presupuesto WHERE EjercicioPpto = '".substr($field_proveedor['Periodo'], 0, 4)."' AND Organismo = '".$CodOrganismo."'";
    ...
    while ($field = mysql_fetch_array($query)) {
		list($MontoAjustado, $MontoCompromiso) = disponibilidadPartida(substr($field_proveedor['Periodo'], 0, 4), $CodOrganismo, $field['cod_partida'], $CodPresupuesto);
