...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte de Resumen de Conceptos con Partidas</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="pdf_resumen_conceptos_proceso_partidas.php" target="iReporte" onsubmit="return validarResumenConceptosProcesoPartida(this);">
...
<br /><div class="divDivision">Reporte Resumen de Conceptos con Partidas</div><br />
