...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte de Retenciones de Jubilaci&oacute;n y Pensi&oacute;n</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="pdf_relacion_jubilacion_pension.php" target="iReporte" onsubmit="return validarReporteJubilacionPension(this);">
...
<table width="1000" class="tblFiltro">
    ...
    <tr>
    	...
    	<td colspan="3">&nbsp; &nbsp; &nbsp; 
    		...
    		<input type="radio" name="tipo" id="txt" onclick="enabledArchivo(this.id)" /> TXT &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<br /><div class="divDivision">Reporte de Retenciones de Jubilaci&oacute;n y Pensi&oacute;n</div><br />
