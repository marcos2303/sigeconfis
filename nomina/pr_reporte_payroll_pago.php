...
<table width="<?=$_width?>" class="tblFiltro">
	<tr>
		...
		<td>
			...
			<select name="fCodOrganismo" id="fCodOrganismo" style="width:275px;" onChange="loadSelect($('#fCodTipoNom'), 'tabla=loadControlNominas2&CodOrganismo='+this.value, 1, ['fCodTipoNom','fPeriodo','fCodTipoProceso']);">
		...
		<td>
			<input type="checkbox" checked onclick="this.checked=!this.checked" />
			<select name="fCodTipoNom" id="fCodTipoNom" style="width:250px;" onChange="loadSelect($('#fPeriodo'), 'tabla=loadControlPeriodos2&CodOrganismo='+$('#fCodOrganismo').val()+'&CodTipoNom='+this.value, 1, ['fPeriodo','fCodTipoProceso']);">
	...
	<tr>
		...
		<td>
			<input type="checkbox" checked onclick="this.checked=!this.checked" />
            <select name="fPeriodo" id="fPeriodo" style="width:75px;" onChange="loadSelect($('#fCodTipoProceso'), 'tabla=loadControlProcesos2&CodOrganismo='+$('#fCodOrganismo').val()+'&CodTipoNom='+$('#fCodTipoNom').val()+'&Periodo='+this.value, 1, ['fCodTipoProceso']);">
