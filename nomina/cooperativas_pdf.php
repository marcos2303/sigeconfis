...
function Cabecera($pdf) {
	...
	$pdf->Cell(190, 10, 'Maestro de Cooperativas', 0, 1, 'C');	
	$pdf->SetDrawColor(0, 0, 0); $pdf->SetFillColor(200, 200, 200); $pdf->SetTextColor(0, 0, 0);
	$pdf->SetFont('Arial', 'B', 6);
	$pdf->Cell(20, 5, 'CODIGO', 1, 0, 'C', 1);
	$pdf->Cell(150, 5, 'NOMBRE', 1, 0, 'C', 1);
...
Cabecera($pdf);
//	Cuerpo
$query=mysql_query("SELECT CodCooperativa, NombreCoop, Estado FROM rh_cooperativa ORDER BY CodCooperativa") or die ($sql.mysql_error());
