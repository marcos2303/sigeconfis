...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Resumen Detallado de Conceptos</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="excel_detallado_conceptos.php" target="iReporte" onsubmit="return validarDetalleConcepto(this);">
...
<table width="1000" class="tblFiltro">
	...
	<tr>
		<td>&nbsp;</td>
		<td>
			<input type="checkbox" name="chkasignacion" id="asignaciones" value="I" /> Asignaciones &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
			<input type="checkbox" name="chkdeduccion" id="deducciones" value="D" /> Deducciones
		</td>
	...
	<tr>
		...
		<td><input type="text" name="CodEmpleado" id="CodEmpleado" style="width:75px;" /></td>
	</tr>
</table>
</div>
...
<br /><div class="divDivision">Resumen Detallado Detallado de Conceptos</div><br />
