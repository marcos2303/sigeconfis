...
while ($field=mysql_fetch_array($query)) {
	...
	$pdf->SetWidths(array(10, 45, 15, 50, 70, 15));
	$pdf->SetAligns(array('C', 'L', 'R', 'L', 'L', 'C'));
	$pdf->Row(array($field['CodEmpleado'], ($field['NomCompleto']), number_format($field['Ndocumento'], 0, '', '.'), ($field['DescripCargo']), ($field['Dependencia']), formatFechaDMA($field['Fingreso'])));
}
//---------------------------------------------------
...
$pdf->SetFont('Arial', '', 8);
$pdf->SetXY(10, 225);
$pdf->Cell(110, 4, ('LICDA. ROSIS REQUENA'), 0, 0, 'L');
$pdf->Cell(80, 4, ('LICDO. FREDDY CUDJOE'), 0, 1, 'L');

$pdf->SetXY(10, 230);
$pdf->Cell(110, 4, ('DIRECTORA RECURSOS HUMANOS'), 0, 0, 'L');
