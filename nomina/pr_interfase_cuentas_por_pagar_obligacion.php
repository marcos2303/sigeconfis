...
$Anio = "$AnioActual";
//	presupuesto
$field_obligacion['CodPresupuesto'] = getVar2("pv_presupuesto", "CodPresupuesto", array('EjercicioPpto','Organismo'), array($Anio,$field_obligacion['CodOrganismo']));
?>
...
<table width="1100" class="tblForm">
    ...
    <tr>
		...
		<td><input type="text" id="NroDocumento" maxlength="20" style="width:150px;" value="<?=$field_obligacion['NroDocumento']?>" disabled /></td>
		<td class="tagForm">* Nro. Factura:</td>
		<td><input type="text" id="NroControl" maxlength="20" value="<?=$field_obligacion['NroControl']?>" style="width:150px;" disabled /></td>
	</tr>
    <tr>
