...
function validarDetalleConcepto(form) {
	...
	if (chkasignacion == "" && chkdeduccion == "") {
		...
		if (document.getElementById("pdf").checked) {
			window.open("pdf_detallado_conceptos.php?forganismo="+forganismo+"&ftiponom="+ftiponom+"&fperiodo="+fperiodo+"&ftproceso="+ftproceso+"&chkdeduccion="+chkdeduccion+"&chkasignacion="+chkasignacion+"&CodEmpleado="+CodEmpleado, "", "toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes");
		} else {
			if (archivo == "") {
...
function validarResumenConceptosProcesoPartida(form) {
	...
	if (document.getElementById("pdf").checked) {
		window.open("pdf_resumen_conceptos_proceso_partidas.php?forganismo="+forganismo+"&ftiponom="+ftiponom+"&fperiodo="+fperiodo+"&ftproceso="+ftproceso+"&CodEmpleado="+CodEmpleado, "", "toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes");
	} else {
		if (archivo == "") {
			alert("¡DEBE INGRESAR EL NOMBRE DEL ARCHIVO A EXPORTAR!");
		} else {
