...
if(!isset($forganismo)) $forganismo = '';
if(!isset($fordenar)) $fordenar = '';
if(!isset($cbuscar)) $cbuscar = '';
if(!isset($filtro)) $filtro = '';
if(!isset($limit)) $limit = '';
if(!isset($ventana)) $ventana = '';
if(!isset($corganismo)) $corganismo = '';
if(!isset($grupo)) $grupo = '';
if(!isset($disabled_ver)) $disabled_ver = '';
if(!isset($FlagControlFiscal)) $FlagControlFiscal = '';
if(!isset($flaginactivo)) $flaginactivo = '';
...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td>
        	<input type="text" id="Dependencia" style="width:300px;" maxlength="100" value="<?=htmlentities(@$field['Dependencia'])?>" <?=$disabled_ver?> />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="tagForm">&nbsp;</td>
		<td>
        	<?php if (@$field['FlagControlFiscal'] == "S") $FlagControlFiscal = "checked" ?>
	...
	<tr>
		<td class="tagForm">&nbsp;</td>
		<td>
        	<?php if (@$field['FlagPrincipal'] == "S") $FlagPrincipal = "checked" ?>
