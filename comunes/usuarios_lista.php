...
<table width="900" class="tblBotones">
	<tr>
		...
		<td align="right">
			...
			<input type="button" class="btLista" id="btAutorizaciones" value="Agregar/Modificar" onclick="cargarOpcion2(this.form, 'gehen.php?anz=usuarios_autorizaciones&opcion=agregar', 'SELF', '', $('#registro').val());" <?=@$btAutorizaciones?> />
