...
<table width="100%" class="tblLista">
	...
	<tr>
		...
		<th scope="col" width="25">Agregar</th>
		<th scope="col" width="25">Modificar</th>
		<th scope="col" width="25">ELiminar</th>
	</tr>
    </thead>
	...
	while ($field_autorizacion = mysql_fetch_array($query_autorizacion)) {
		...
		<tr class="trListaBody">
			...
			<td align="center">
        		<input title="Agregar"  type="checkbox" name="FlagAgregar" id="FlagAgregar_<?=@$field_autorizacion['Concepto']?>" <?=@$FlagAgregar?> <?=@$dAgregar?> <?=@$disabled_ver?> />
            </td>
			<td align="center">
				<input title="Modificar" type="checkbox" name="FlagModificar" id="FlagModificar_<?=$field_autorizacion['Concepto']?>" <?=@$FlagModificar?> <?=@$dModificar?> <?=@$disabled_ver?> />
            </td>
			<td align="center">
