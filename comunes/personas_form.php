...
if(!isset($display_submit) or $display_submit == '') $display_submit= '';
if ($opcion == "nuevo") {
	$accion = "nuevo";
...
<table width="900px" class="tblForm">
	...
	<tr>
		...
		<td colspan="3">
            ...
            &nbsp; &nbsp; &nbsp; 
            <input type="checkbox" id="EsProveedor" value="S" onclick="this.checked=!this.checked;" <?=@$EsProveedor?> <?=@$disabled_ver?> /> Proveedor
            &nbsp; &nbsp; &nbsp; 
...
<table width="900px" class="tblForm">
	...
	<tr>
		...
		<td>
        	<input type="checkbox" id="FlagSNC" value="S" <?=@$FlagSNC?> <?=$disabled_ver?> />
		</td>
