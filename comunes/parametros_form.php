<?php
if(!isset($filtro) or $filtro == '') $filtro = '';
if(!isset($filtrar) or $filtrar == '') $filtrar = '';
if(!isset($faplicacion) or $faplicacion == '') $faplicacion = '';
if(!isset($fbuscar) or $fbuscar == '') $fbuscar = '';
if(!isset($caplicacion) or $caplicacion == '') $caplicacion = '';
if(!isset($cbuscar) or $cbuscar == '') $cbuscar = '';
if(!isset($limit) or $limit == '') $limit = '';
if(!isset($grupo) or $grupo == '') $grupo = '';
if(!isset($forganismo) or $forganismo == '') $forganismo = '';
if(!isset($disabled_modificar) or $disabled_modificar == '') $disabled_modificar = '';
if(!isset($field_parametro) or $field_parametro == '') $field_parametro = '';
if(!isset($disabled_ver) or $disabled_ver == '') $disabled_ver = '';
if ($opcion == "nuevo") {
	$accion = "nuevo";
