...
$Revisado = " $_REVISADO[Nivel] $_REVISADO[Nombre] $nl DIRECTORA DE RECURSOS HUMANOS (E)";
$Conformado = " $_CONFORMADO[Nivel] $_CONFORMADO[Nombre] $nl $_CONFORMADO[Cargo]";
##
$pdf->SetXY(24, 250);
$pdf->MultiCell(70, 5, utf8_decode($Revisado), 0, 'L');
$pdf->SetXY(124, 250);
$pdf->MultiCell(70, 5, utf8_decode($Conformado), 0, 'L');
