...
if(!isset($fclase) or $fclase == '') $fclase = '';
if(!isset($ftipo) or $ftipo == '') $ftipo = '';
if(!isset($fbuscar) or $fbuscar == '') $fbuscar = '';
if(!isset($ctipo) or $ctipo == '') $ctipo = '';
if(!isset($cclase) or $cclase == '') $cclase = '';
if(!isset($cbuscar) or $cbuscar == '') $cbuscar = '';
if(!isset($limit) or $limit == '') $limit = 100;
if ($filtrar == "default") {
