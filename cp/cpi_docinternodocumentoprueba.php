...
<?php
 ...
 $scon="select *  from 
			     ...
			     where 
					   ...
					   Cod_TipoDocumento = '$cod_tipodocumento' limit $nropersona, 1";
...
<tr><td width="707">
  ...
  <tr>
   <td width="3"></td>
   <td width="124" align="center"><img src="imagenes/logo-CMC.png" style="height:80px; width:80px" /></td>
   <td width="10"></td>
   <td width="420">
   <!-- *********************** -->
...
<tr><td>
  ...
  <tr>
    <td width="34"></td>
    <td width="79"></td>
    <td width="563"><font face="Arial" size="3"><?=htmlentities($fc['DescripCargo']);?></font></td>
  </tr>
   <tr><td height="5"></td></tr>
  <tr>
    <td></td>
...
<tr><td>
  ...
  $s_remitente = "select 
				   ...
				   from 
					   ...
					   rh_puestos b
				  where 
				       a.CodPersona='".$fa['Cod_Remitente']."' and 
					   b.CodCargo='".$fa['Cod_CargoRemitente']."'";
   $q_remitente = mysql_query($s_remitente) or die ($s_remitente.mysql_error());
   $f_remitente = mysql_fetch_array($q_remitente);
  ...
  ?>
    <td width="58"></td>
    <td align="center" width="365"><font face="Arial" size="3"><?=$f_remitente['NomCompleto']?></font></td>
    <td width="61"></td>
  </tr>
  <tr>
    <td width="58"></td>
    <td align="center" width="600"><font face="Arial" size="3"><?=$f_remitente['DescripCargo']?></font></td>
    <td width="61"></td>
  </tr>
  </table>
  <!-- *********************** -->
