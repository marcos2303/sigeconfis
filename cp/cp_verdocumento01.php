...
<?php
list($cod_tipodocumento, $cod_documentocompleto, $codpersona, $periodo, $codorganismo) = preg_split('/[|]/',$_GET['registro'] );
...
<tr>
 ...
 <?php 
   if($field['FechaRegistro']!='0000-00-00'){list($a,$m,$d)=preg_split('/[.-]/',$field['FechaRegistro']);$fRegistro=$d.'-'.$m.'-'.$a;}
 ?>
...
<tr style="border-style:double">
 ...
 <td class="tagForm">Fecha Recibido:</td>
  <?php
   if(@$field['FechaDocumentoExt']!='0000-00-00'){@list($a,$m,$d)=preg_split('/[.-]/',@$field['FechaDocumentoExt']);$fRegistroExt=$d.'-'.$m.'-'.$a;}
 ?>
...
<tr>
 ...
 ?> 
  <td colspan="3"><input type="text" id="organismo" name="organismo" class="selectBig" value="<?=$fconsulta['0'];?>" readonly></td>
</tr>
<tr>
  <td class="tagForm">Dependencia:</td>
  <td colspan="2"><input type="text" id="dependencia" name="dependencia" class="selectBig" value="<?=$fconsulta['1'];?>" readonly></td>
</tr>
<tr>
 <td class="tagForm">Remitente:</td>
 <td><input type="text" id="remitente" name="remitente" size="60" value="<?=$fconsulta['2'];?>" readonly/></td>
 <td class="tagForm">Cargo:</td>
 <td><input type="text" id="cargo" name="cargo" size="40" value="<?=$fconsulta['3'];?>" readonly/></td>
</tr>
<tr><td height="5"></td></tr>
<tr>
...
<tr>
  ...
  <td colspan="3"><textarea name="asunto" id="asunto" rows="2" cols="80" readonly><?=$field['Descripcion'];?></textarea></td>
</tr>
<tr>
  <td class="tagForm"></td>
  <td colspan="3"></td>
