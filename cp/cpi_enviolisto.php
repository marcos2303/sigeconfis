...
<?php
  ...
  foreach ($det as $detalle) {
	@list($cod_documento, $periodo, $codpersona, $cod_tipodocumento)=preg_split( '/[|]/', $detalle);$i++;
 ...
 <tr>
   ...
   <table class="tblForm" width="425px">
    ...
    <tr>
	 ...
	 <input name="nomb_remitente" id="nomb_remitente" type="text" size="68" value="<?=@$fcon[0]?>" readonly/></td>
    </tr>
    <tr>
   ...
   <table class="tblForm" width="435px">
    <tr>
      ...
      <table width="435px" class="tblLista">
	   ...
	   foreach ($det as $detalle) {
		   @list($cod_documento, $periodo, $codpersona)=preg_split( '/[|]/', $detalle);$i++;
           //echo"$cod_documento, $periodo, $codpersona";	
