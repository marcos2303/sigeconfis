...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Documentos de Salida | Nuevo Registro</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" action="<?=$regresar?>.php?limit=0" method="post"  onsubmit="return VerificarDatos(this);">
...
<tr>
  ...
  <td width="321">
     <?php
	  echo"<input type='hidden' id='fElaboradoPor' name='fElaboradoPor' value='".@$fElaboradoPor."'/>
           ...
           <input type='hidden' id='regresar' name='regresar' value='".@$regresar."'/>
		   <input type='hidden' name='verificador' id='verificador'/>";
	  
	  //// CONSULTA PARA TIPOS DE CORRESPONDENCIA
	  $sql="SELECT * FROM cp_tipocorrespondencia WHERE FlagUsoExterno='1'";
 ...
 <? $fecha=date("d-m-Y");?>
 <td width="325"><input type="text" id="fecha_documento" name="fecha_documento" size="10" value="<?=$fecha;?>" style="text-align:right" readonly/>*(dd-mm-aaaa)</td>
</tr>
...
<tr>
  ...
  <td colspan="2"><input type="text" id="asunto" name="asunto" size="84"/>*</td>
</tr>
<tr>
...
<tr><td height="5"></td></tr>
 <tr>
  ...
  <tr>
    ...
    <td><input type="text" id="destinatario_int" name="destinatario_int" size="68" value=""/></td>
    <td class="tagForm">Cargo:</td>
    <td><input type="text" id="cargodestinatario_int" name="cargodestinatario_int" size="68" value=""/>
...
<tr>
  ...
  <table width="800px" class="tblBotones">
   <tr>
 	<td align="right">
    <input type="button" class="btLista" id="btInsertarEmpleado" value="Ins. Org." onclick="Verificar()|cargarVentana(this.form,'lista_organismosext.php?limit=0&ventana=insertarDestinatarioOrgExt&tabla=item', 'height=600, width=800, left=50, top=50, resizable=yes');" /><input type="button" class="btLista" id="btInsertarDependencia" value="Ins. Dep." onclick="Verificar()|cargarVentana(this.form,'lista_dependenciasext.php?limit=0&ventana=insertarDestinatarioDepExt&tabla=item', 'height=600, width=800, left=50, top=50, resizable=yes');" />
    <input type="button" class="btLista" id="btInsertarParticular" value="Ins. Par." onclick="Verificar()|cargarVentana(this.form,'lista_particulares.php?limit=0&ventana=insertarDestinatarioParticularExt&tabla=item', 'height=600, width=800, left=50, top=50, resizable=yes');" />
  ...
  <td valign="top" style="height:150px; width:800px;">
    ...
    <tr>
      ...
      <table width="800px" class="tblLista">
       <tr>
        <th scope="col" class="trListaHead">Organismo / Dependencia</th>
        <th scope="col" class="trListaHead">Representante</th>
...
return guardarSalidaExt(formulario);
