...
<?php
 list($cod_tipocuenta, $cod_documentocompleto)=preg_split('/[|]/', @$_POST['registro']);
 //echo $cod_tipocuenta;
...
<tr> <!-- ///////////  PRIMER ////////// -->
  ...
  <tr>
     ...
     <?php  if($f['FechaDocumento']!='0000-00-00'){list($a,$m,$d)=preg_split('/[.-]/',$f['FechaDocumento']);$f_documento=$d.'-'.$m.'-'.$a;} ?>
     ...
     <?php
           $scon="select
                  ...
                  where 
						...
						rh.CodCargo = '".$f['Cod_CargoRemitente']."' and 
						md.CodDependencia = '".$f['Cod_Dependencia']."'"; 
           $qcon=mysql_query($scon) or die ($scon.mysql_error()); //echo $scon;die;
		    ...
		    $fdisext = mysql_fetch_array($qdisext);
			   $sa="select
                     ...
                     where 
						  ...
						  rh.CodCargo = '".$fdisext['CodCargo']."' and 
						  md.CodDependencia = '".$fdisext['CodDependencia']."' "; 
