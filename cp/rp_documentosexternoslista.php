...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Lista Documentos Externos</td>
...
if (@$fDestinatario !="") $cDestinatario = "checked"; else $dDestinatario = "disabled";
...
echo "
<form name='frmentrada' action='rp_documentosexternoslistapdf.php' method='POST' target='reporte'>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroDocumentosSalida(this.form, 0);'></center>
