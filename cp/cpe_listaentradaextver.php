...
<table class="tblForm" width="895px" border="0">
 <tr>
  ...
  <tr>
    ...
    <?php
     @list($a, $m, $d)=preg_split( '/[.-]/', @$field['FechaDocumentoExt']); $f_documentoext=$d.'-'.$m.'-'.$a;
       ...
       <tbody id="listaDetalles">
		...
		if($rver!=0){
		   ...
		   for($i=0; $i<$rver; $i++){
			 ...
			 ?>
		     <tr>
             <td align="center" width="20"><?=@$fc['Dependencia']?></td>
             <td align="left" width="70"><?=@$fc[NomCompleto];?></td>
             <td align="left" width="70"><?=@$fc[DescripCargo];?></td>
		     </tr>
		   <? }
