...
$MAXLIMIT=30; 
echo "
<form name='frmentrada' action='rp_docsalidahistxdocpdf.php' method='POST' target='reporte'>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroSalidaHistRP(this.form,0)'></center>
