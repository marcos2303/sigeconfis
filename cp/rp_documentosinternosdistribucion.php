...
$MAXLIMIT=30;
echo "
<form name='frmentrada' action='rp_documentosinternosdistribucionpdf.php' method='POST' target='reporte'>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroDocumentoInternoDistribucionRP(this.form, 0);'></center>
