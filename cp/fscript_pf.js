...
function verificarOrganismoExterno(form, accion) {
	...
	if (descripcion == "" || descripcionc == "" || form.ciudad.value == "") alert("¡Debe ingresar los campos obligatorios!");
		...
		ajax.send("modulo=ORGANISMOS-EXTERNOS&accion="+accion+"&codigo="+form.codigo.value+"&descripcion="+descripcion+"&descripcionc="+descripcionc+"&rep="+rep+"&docr="+docr+"&www="+www+"&docf="+docf+"&fecha="+fecha+"&dir="+dir+"&ciudad="+form.ciudad.value+"&tel1="+tel1+"&tel2="+tel2+"&tel3="+tel3+"&fax1="+fax1+"&fax2="+fax2+"&logo="+logo+"&status="+status+"&nreg="+nreg+"&treg="+treg+"&control="+control+"&cargo="+cargo);
