...
function loadSelectValores($tabla, $codigo, $opt) {
	...
	switch ($opt) {
		case 0:
			foreach ($c as $cod) {
				if ($cod == $codigo) echo "<option value='".$cod."' selected>".utf8_encode($v[$i])."</option>";
				else echo "<option value='".$cod."'>".utf8_encode($v[$i])."</option>";
				$i++;
			}
			break;
...
function getAplicaciones($aplicacion, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$aplicacion) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
			...
			if ($rows!=0) {
				$field=mysql_fetch_array($query);
				echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
	}
}
...
function getPaises($pais, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$pais) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1]); 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getEstados($estado, $pais, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$estado) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1]); 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getMunicipios($municipio, $estado, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$municipio) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getCiudades($ciudad, $municipio, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$ciudad) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTPago($tpago, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tpago) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getDependencias($dependencia, $organismo, $opt) {
	...
	switch ($opt) {
		case 0:
			$sql="SELECT CodDependencia, Dependencia FROM mastdependencias WHERE CodOrganismo='".$organismo."' ORDER BY CodDependencia";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$dependencia) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getDivisiones($division, $dependencia, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$division) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getGrupos($grupo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$grupo) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getSeries($serie, $grupo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$serie) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTCargo($tcargo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tcargo) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getNiveles($nivelcargo, $tipocargo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$nivelcargo) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getCargos($cargo, $serie, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$cargo) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTTrabajador($ttrabajador, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$ttrabajador) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTNomina($tnomina, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tnomina) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getPNomina($pnomina, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$pnomina) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTCese($tcese, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tcese) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTSeguros($tseguro, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tseguro) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTContratos($tcontrato, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tcontrato) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getFContratos($fcontrato, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$fcontrato) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getMiscelaneos($detalle, $maestro, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$detalle) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getBancos($banco, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$banco) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getGInstruccion($grado, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$grado) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getNInstruccion($nivel, $grado, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$nivel) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1]); 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getCEstudios($centro, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$centro) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getIdiomas($idioma, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$idioma) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getProfesiones($profesion, $grado, $area, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field['CodProfesion']==$profesion) echo "<option value='".$field['CodProfesion']."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field['CodProfesion']."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getGCargo($categoria, $grado, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field['Grado']==$grado) echo "<option value='".$field['Grado']."' selected>".utf8_encode($field['Grado'])."</option>"; 
				else echo "<option value='".$field['Grado']."'>".utf8_encode($field['Grado'])."</option>";
			}
			break;
		...
		case 1:
			...
			if ($rows != 0) {
				$field=mysql_fetch_array($query);
				echo "<option value='".$field['Grado']."' selected>".utf8_encode($field['Grado'])."</option>"; 
			}
			break;
	}
}
...
function getCursos($curso, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$curso) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTEvaluaciones($valor, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$valor) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
function getTEvaluaciones2($valor, $opt) {
	...
	switch ($opt) {
		case 0:
			for ($i=0; $i<$total; $i++) {
				if ($valor==$vvalor[$i]) echo "<option value='".$vvalor[$i]."' selected>".utf8_encode($tvalor[$i])."</option>";
				else echo "<option value='".$vvalor[$i]."'>".utf8_encode($tvalor[$i])."</option>";
			}
			break;
		case 1:
			for ($i=0; $i<$total; $i++) {
...
function loadSelect($tabla, $campo1, $campo2, $codigo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			$query = mysql_query($sql) or die ($sql.mysql_error());
			while ($field = mysql_fetch_array($query)) {
				if ($field[0] == $codigo) { ?><option value="<?=$field[0]?>" selected="selected"><?=utf8_encode($field[1])?></option><?php }
				else { ?><option value="<?=$field[0]?>"><?=utf8_encode($field[1])?></option><?php }
			}
			break;
		...
		case 1:
			...
			$query = mysql_query($sql) or die ($sql.mysql_error());
			while ($field = mysql_fetch_array($query)) {
				?><option value="<?=$field[0]?>" selected="selected"><?=utf8_encode($field[1])?></option><?php
			}
			break;
	}
}
...
function loadSelectDependiente($tabla, $campo1, $campo2, $campo3, $codigo1, $codigo2, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			$query = mysql_query($sql) or die ($sql.mysql_error());
			while ($field = mysql_fetch_array($query)) {
				if ($field[0] == $codigo1) { ?><option value="<?=$field[0]?>" selected="selected"><?=utf8_encode($field[1])?></option><?php }
				else { ?><option value="<?=$field[0]?>"><?=utf8_encode($field[1])?></option><?php }
			}
			break;
...
function getTipoProcesoNomina($codigo, $periodo, $nomina, $codorganismo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field['Codigo']==$codigo) echo "<option value='".$field['Codigo']."' selected>".utf8_encode($field['Descripcion'])."</option>"; 
				else echo "<option value='".$field['Codigo']."'>".utf8_encode($field['Descripcion'])."</option>";
			}
			break;
...
////   FUNCIONES PARA CORRESPONDENCIA
//// _________________________________________________________________
//	FUNCION PARA CARGAR LOS ORGANISMOS EN UN SELECT
function getOrganismos($opt, $organismo) {
	connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$organismo) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
...
//	FUNCION PARA CARGAR SELECT DE UNO SELECCIONADO EN UN SELECT
function getDependencia($dependencia, $organismo, $opt) {
	connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt) {
		case 0:
		...
		case 3:
			...
			break;
		case 4:
			$sql="SELECT CodDependencia, Dependencia FROM mastdependencias WHERE CodOrganismo='".$organismo."' AND CodDependencia='".$dependencia."' ORDER BY CodDependencia";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
...
//// --------------------------------------------------------------------------
//// FUNCION PARA CARGAR LOS ORGANISMOS EN UN SELECT MODULO CORRESPONDENCIA
//// --------------------------------------------------------------------------
function getOrganismosExt($opt, $organismo) {
connect();
  if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt) {
	   case 0:
			$sql="SELECT CodOrganismo, Organismo FROM pf_organismosexternos WHERE CodOrganismo<>'' ORDER BY CodOrganismo";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
...
//// ______________________________________________________________________________
//// FUNCION PARA CARGAR SELECT DE UNO SELECCIONADO EN UN SELECT "MODULO CORRESPONDENCIA"
function getDependenciaExt($dependencia, $organismo, $opt) {
	connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt) {
		case 0:
...
//// ______________________________________________________________________________
//	FUNCION PARA CARGAR SELECT DE UNO SELECCIONADO  REPRESENTANTE DEPENDENCIA EXTERNA
function getRepreExt($destinatario, $dependencia, $opt, $organismo) {
	connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt) {
		case 0:
			$sql="SELECT Representante  FROM pf_dependenciasexternas WHERE CodDependencia='".$dependencia."' AND Representante<>'' ORDER BY CodDependencia";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$destinatario) echo "<option value='".$field[0]."' selected>".utf8_encode($field[0])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[0])."</option>";
			}
			break;
		case 1:
			$sql="SELECT Representante  FROM pf_dependenciasexternas WHERE CodDependencia='".$dependencia."' AND CodOrganismo='".$organismo."' AND Representante<>'' ORDER BY CodDependencia";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
...
//// --------------------------------------------------------------------------------
//// FUNCION PARA CARGAR SELECT DE UNO SELECCIONADO. REPRESENTANTE DEPENDENCIA INTERNA
//// --------------------------------------------------------------------------------
function  getRepreInt($remitente_int, $dep_int, $opt){
connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt){
	case 0: 
			$sql="select CodPersona from mastdependencias where CodDependencia='$dep_int'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
			for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
			  $scon="select CodPersona, NomCompleto from mastpersonas where CodPersona='".$field['0']."'";
			  $qcon=mysql_query($scon);
			  $fcon=mysql_fetch_array($qcon);
			  if($fcon[0]==$remitente_int) echo "<option value='".$fcon[0]."'>".utf8_encode($fcon[1])."</option>";
			  else echo "<option value='".$fcon[0]."'>".utf8_encode($fcon[1])."</option>";
			}
		   break;
    }
}
...
//// FUNCION PARA CARGAR SELECT DE UNO SELECCIONADO. REPRESENTANTE DEPENDENCIA INTERNA
//// --------------------------------------------------------------------------------
function  getCargoRepreInt($cargodestinatario_int, $destinatario_int, $opt){
connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt){
	case 0: 
			$sql="select CodCargo from mastempleados where CodPersona='$destinatario_int'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
			for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
			  $scon="select CodCargo, DescripCargo from rh_puestos where CodCargo='".$field['0']."'";
			  $qcon=mysql_query($scon);
			  $fcon=mysql_fetch_array($qcon);
			  if($fcon[0]==$remitente_int) echo "<option value='".$fcon[0]."'>".utf8_encode($fcon[1])."</option>";
			  else echo "<option value='".$fcon[0]."'>".utf8_encode($fcon[1])."</option>";
...
//// --------------------------------------------------------------------------------
//// FUNCION PARA CARGAR SELECT DE UNO SELECCIONADO CARGO REPRESENTANTE DEPENDENCIA INTERNA
//// --------------------------------------------------------------------------------
function  getCargoRepInt($cargoremitente_int, $remitente_int, $opt){
connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt){
	case 0: 
			$sql="select CodCargo from mastempleado where CodPersona='$remitente_int'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
			for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
			  $scon="select DescripCargo from rh_puestos where CodCargo='".$field['0']."'";
			  $qcon=mysql_query($scon);
			  $fcon=mysql_fetch_array($qcon);
			  if($fcon[0]==$remitente_int) echo "<option value='".$fcon[0]."'>".utf8_encode($fcon[0])."</option>";
			  else echo "<option value='".$fcon[0]."'>".utf8_encode($fcon[0])."</option>";
			}
		   break;
    }
}
//// ______________________________________________________________________________
//	FUNCION PARA CARGAR SELECT DE UNO SELECCIONADO EN UN SELECT
function getCargoExt($cargodestinatario, $destinatario, $opt, $organismo) {
	connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$dependencia) echo "<option value='".$field[0]."' selected>".utf8_encode($field[0])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[0])."</option>";
			}
			break;
		case 1:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$cargodestinatario) echo "<option value='".$field[0]."' selected>".utf8_encode($field[0])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[0])."</option>";
			}
			break;
	}
...
//// --------------------------------------------------------------------------------------
//// FUNCION PARA CARGAR REMITENTE DEPENDENCIA DOCUMENTOS RECIBIDOS "cpi_depenrecibido.php"
//// --------------------------------------------------------------------------------------
function getRemitenteDepRecibido($opt, $dependencia = null) {
connect();
 if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
 switch ($opt) {
  case 0:
	$sql="SELECT CodDependencia, Dependencia FROM mastdependencias WHERE CodOrganismo='".$_SESSION['ORGANISMO_ACTUAL']."' ORDER BY CodDependencia";
	//echo $sql;die;
        $query=mysql_query($sql) or die ($sql.mysql_error());
	$rows=mysql_num_rows($query);
	for ($i=0; $i<$rows; $i++) {
		$field=mysql_fetch_array($query);
		if ($field[0]==$dependencia) echo "<option value='".$field[0]."' selected='selected'>".utf8_encode($field[1])."</option>"; 
		else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
	}
	break;
  }
...
//// --------------------------------------------------------------------------------------
////	FUNCION PARA CARGAR LOS REMITENTES EN UN SELECT
function getRemitente($opt, $remitente) {
	connect();
	switch ($opt) {
		case 0:			
			$sorg="select CodOrganismo, Organismo from pf_organismosexternos where CodOrganismo<>''";
			$qorg=mysql_query($sorg) or die ($sorg.mysql_error);
			$rorg=mysql_num_rows($qorg);
			for ($i=0; $i<$rorg; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$remitente) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 1:
			$sql="select Remitente from cp_documentoextsalida";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for($i=0; $i<$rows; $i++){
			   $field=mysql_fetch_array($query);
			   if($field[0]==$remitente){
			     echo "<option value='".$field[0]."' selected>".utf8_encode($field[0])."</option>";
				 $remit= $field[0];
			   } else{
			     echo "<option value='".$field[0]."'>".utf8_encode($field[0])."</option>";
			   }
			}
			break;
	    case 2:
			...
			for($i=0; $i<$rorg; $i++){
			   ...
			   if ($forg[0]==$remitente) echo "<option value='".$forg[0]."' selected>".utf8_encode($forg[1])."</option>"; 
			   else echo "<option value='".$forg[0]."'>".  utf8_encode($forg[1])."</option>"; 
			} 
			break;
		case 3:
			$sql="SELECT s.CodOrganismo, o.Organismo FROM seguridad_alterna s INNER JOIN mastorganismos o ON (s.CodOrganismo=o.CodOrganismo) WHERE s.Usuario='".$_SESSION["USUARIO_ACTUAL"]."' AND s.CodAplicacion='".$_SESSION["APLICACION_ACTUAL"]."' AND s.FlagMostrar='S' GROUP BY s.CodOrganismo ORDER BY s.CodOrganismo";
			...
			break;
		case 4:
		    $sql="select CodDependencia,Dependencia from mastdependencias where CodOrganismo='".$_SESSION['ORGANISMO_ACTUAL']."'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
			for($i=0;$i<$rows;$i++){
			   $field=mysql_fetch_array($qry);
...
//// ------------------------------------------------------------------------------
//// SEGURIDAD ALTERNA PARA DOCUMENTOS INTERNOS 
...
//// ------------------------------------------------------------------------------
//	FUNCION PARA CARGAR LOS REMITENTES EN UN SELECT
function getRecibidoPor($opt, $recibidoPor) {
	connect();
	switch ($opt) {
		case 0:
			$sql="SELECT distinct RecibidoPor FROM cp_documentoextentrada";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if(@$field[0]!=@$codPer){
				 $codPer = $field[0];
				$spersona="select distinct NomCompleto from mastpersonas where CodPersona='".$field[0]."'";
				$qpersona=mysql_query($spersona) or die ($spersona.mysql_error());
				$fpersona=mysql_fetch_array($qpersona);
				if ($field[0]==$recibidoPor) echo "<option value='".$field[0]."' selected>".$fpersona[0]."</option>"; 
				else
					  echo "<option value='".$field[0]."'>".utf8_encode($fpersona[0])."</option>";
...
//// ______________________________________________________________________________
//	FUNCION PARA CARGAR ELABORADO POR DOCUMENTO SALIDA EXTERNA
function getElaboradoPor($opt, $elaboradoPor) {
	connect();
	switch ($opt) {
		case 0:
			$sql="SELECT CodDependencia, Dependencia FROM mastdependencias where CodOrganismo='".$_SESSION['ORGANISMO_ACTUAL']."'";
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$elaboradoPor) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
	}
...
//// ______________________________________________________________________________
//	FUNCION PARA CARGAR El ESTADO EN UN SELECT
//// ______________________________________________________________________________
//	FUNCION PARA CARGAR El ESTADO EN UN SELECT
function getEstado($opt, $estado) {
	connect();
	$status[0]="Pendiente"; $v_status[0]="PE";
	$status[1]="Recibido"; $v_status[1]="RE";
	$status[2]="Completado"; $v_status[2]="CO";
	$total=3;
	switch ($opt) {
	   case 0:
		      for ($i=0; $i<$total; $i++) {
				if ($valor==$v_status[$i]) echo "<option value='".$v_status[$i]."' selected>".utf8_encode($status[$i])."</option>";
				else echo "<option value='".$v_status[$i]."'>".utf8_encode($status[$i])."</option>";
			  }
			  break;		
	   case 1:
		      for ($i=0; $i<$total; $i++) {
				if ($estado==$v_status[$i]){
				   echo "<option value='".$v_status[$i]."' selected>$status[$i]</option>";
				}else{ 
				   echo "<option value='".$v_status[$i]."'>$status[$i]</option>";
			    }
			  }
			  break;
	   case 2:
			  ...
			  break;
	   case 3:
		     $valor[0] = "Preparación"; $vEstado[0] = "PR";
			 $valor[1] = "Preparado";   $vEstado[1] = "PP";
			 $valor[2] = "Enviado";     $vEstado[2] = "EV";
			 $valor[3] = "Recibido";    $vEstado[3] = "RE";
			 $valor[4] = "Anulado";     $vEstado[4] = "AN";
			 $vTotal = 5;
			 for ($i=0; $i<$vTotal; $i++){
			    if($estado==$vEstado[$i]){
				  echo "<option value='".$vEstado[$i]."' selected>$valor[$i]</option>";
				}else{
				  echo "<option value='".$vEstado[$i]."'>$valor[$i]</option>";
				}
			  }
			  break;
	   case 4:
		     $valor[0] = "Preparación"; $vEstado[0] = "PR";
			 $valor[1] = "Pendiente"; $vEstado[1] = "PE";
			 $valor[2] = "Enviado"; $vEstado[2] = "EV";
			 $valor[3] = "Completado"; $vEstado[3] = "CO";
			 $vTotal = 4;
			 for ($i=0; $i<$vTotal; $i++){
			    if($estado==$vEstado[$i]){
				  echo "<option value='".$vEstado[$i]."' selected>$valor[$i]</option>";
			  ...
			  break;
	   case 5:
		     $valor[0] = "Pendiente"; $vEstado[0] = "PE";
			 $valor[1] = "Devuelto"; $vEstado[1] = "DV";
			 $vTotal = 2;
			 for ($i=0; $i<$vTotal; $i++){
			    if($estado==$vEstado[$i]){
				  echo "<option value='".$vEstado[$i]."' selected>$valor[$i]</option>";
			  ...
			  break;
	   case 6:
	        $valor[0] = "Recibido"; $vEstado[0] = "RE";
			$valor[1] = "Completado"; $vEstado[1] = "CO";
			$vTotal = 2;
			for($i=0;$i<$vTotal; $i++){
			  if($estado==$vEstado[$i]){
				echo"<option value='".$vEstado[$i]."' selected>$valor[$i]</option>"; 
...
//// ******************************************************************************
//// ------------------------------------------------------------------------------
function getEstadoAtender($opt, $estado) {
	connect();
	$status[0]="Enviado"; $v_status[0]="EV";
	$status[1]="Recibido"; $v_status[1]="RE";
	$total=2;
	switch ($opt) {
		case 0:
...
//// ______________________________________________________________________________
//	FUNCION PARA CARGAR TIPO DE DOCUMENTO EN UN SELECT
function getOrdenarDocumento($opt, $ordenar) {
	connect();
	switch ($opt) {
		case 0:
			$sql="SELECT Cod_TipoDocumento 
			        FROM cp_documentoextentrada";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$ordenar) echo "<option value='".$field[0]."' selected>".$field[0]."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[0])."</option>";
			}
			break;
		case 1:
...
//// ______________________________________________________________________________
//	FUNCION PARA CARGAR LOS REMITENTES EN UN SELECT
function getDestinatario($opt, $destinatario) {
	connect();
	switch ($opt) {
		case 0:
			$sql="SELECT Cod_Organismo,Organismo 
			        FROM pf_organismosexternos
				ORDER BY Cod_Organismo";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
			...
			break;
		case 1:
			$sql="SELECT CodOrganismo, Organismo FROM pf_organismosexternos WHERE CodOrganismo<>''";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$destinatario) echo "<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 3:
...
//// -------------------------------------------------------------------------------------
//// OBTENER EL NOMBRE DEL REPRESENTANTE DEPENDENCIA INTERNA PARA CORRESPONDENCIA EXT SALIDA

//// -------------------------------------------------------------------------------------
//// OBTENER EL CARGO DEL REPRESENTANTE DEPENDENCIA INTERNA PARA CORRESPONDENCIA EXT SALIDA
function  getDestInt($cargoremitente_int, $remitente_int, $opt){
connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt){
	case 0: 
...
//// -------------------------------------------------------------------------------------
function getTdocumento($opt, $tipodocumento){
connect();
  
   switch($opt){
      case 0:
	        $sql="select Cod_TipoDocumento, Descripcion from cp_tipocorrespondencia where FlagUsoExterno='1'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
            for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
			  if($field[0]==$tipodocumento) echo"<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>";
			  else echo"<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
	   case 1:
	        $sql="select Cod_TipoDocumento, Descripcion from cp_tipocorrespondencia where FlagProcedenciaExterna='1'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
            for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
			...
			break;
		case 2:
	        $sql="select Cod_TipoDocumento, Descripcion from cp_tipocorrespondencia where FlagUsoExterno='1' or FlagUsoInterno='1'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
            for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
			  if($field[0]==$tipodocumento) echo"<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			  else echo"<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
		case 3:
	        $sql="select Cod_TipoDocumento, Descripcion from cp_tipocorrespondencia where FlagUsoInterno='1'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
            for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
			...
			break;
		case 4:
	        $sql="select Cod_TipoDocumento, Descripcion from cp_tipocorrespondencia where FlagUsoInterno='1' or FlagProcedenciaExterna='1'";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
            for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
...
function getObtenerValor($organismo, $dependencia){
	...
	if ($dependencia != "")
		$sql = "SELECT
				...
				FROM
					mastdependencias d
					INNER JOIN mastpersonas mp ON (d.CodPersona = mp.CodPersona)
		...
		$sql = "SELECT
				...
				FROM
					mastorganismos o
					INNER JOIN mastdependencias md ON (o.CodPersona = md.CodPersona)
					INNER JOIN mastpersonas mp ON (o.CodPersona = mp.CodPersona)
					INNER JOIN mastempleado me ON (mp.CodPersona = me.CodPersona)
					INNER JOIN rh_puestos c ON (me.CodCargo = c.CodCargo)
	...
	//// Consulta para obtener datos de nivelación
	$sa = "select max(Secuencia) from rh_empleadonivelacion where CodPersona = '".@$field['3']."' ";
	$qa = mysql_query($sa) or die ($sa.mysql_error());
	$fa = mysql_fetch_array($qa);
	
	//// Select para obtener datos a mostrar
	$sb = "select 
	             rn.CodCargo,
				 rp.DescripCargo				 
		    from 
			    mastempleado rn
				inner join rh_puestos rp on (rn.CodCargo = rp.CodCargo)
		   where 
		        rn.CodPersona = '".@$field['3']."'";
        //echo $sb;die;
	$qb = mysql_query($sb) or die ($sb.mysql_error()); 
	$fb = mysql_fetch_array($qb);
	
	return array(@$field[0], @$fb[DescripCargo], @$field[2], @$field[3], @$fb[CodCargo]);
	...
	$qry = mysql_query($sql) or die ($sql.mysql_error());
	if (mysql_num_rows($qry) != 0)  $field = mysql_fetch_array($qry);
	return array($field[0], $field[1], $field[2], $field[3], $field[4]);*/
}
//// -------------------------------------------------------------------------------------
function getDependenciasExternas($dependencia, $organismo, $opt) {
	connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt) {
		case 0:
			$sql="SELECT CodDependencia, Dependencia  FROM pf_dependenciasexternas WHERE CodOrganismo='".$organismo."'";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
...
//// -------------------------------------------------------------------------------------
function getDepRemitente($opt, $dependencia){
connect();
  ...
  if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	...
	switch ($opt) {
     case 0:
		    $sql="SELECT CodDependencia, Dependencia  FROM pf_dependenciasexternas where CodDependencia<>''";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query); echo $rows;
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
...
//// -------------------------------------------------------------------------------------
function getObtenerValorExterno($organismo, $dependencia){
	connect();
	if ($dependencia != "") 
		$sql = "SELECT
					Representante,
	...
	$qry = mysql_query($sql) or die ($sql.mysql_error());
	if (mysql_num_rows($qry) != 0)  $field = mysql_fetch_array($qry);
	return array(utf8_encode($field[0]), utf8_encode($field[1]));
}
//// -------------------------------------------------------------------------------------
//// -------------------------------------------------------------------------------------
function getProcedencia($opt, $procedencia) {
	connect();
	$status[0]="Interna"; $v_status[0]="INT";
	$status[1]="Externa"; $v_status[1]="EXT";
	$total=2;
	switch ($opt) {
		case 0:
		      for ($i=0; $i<$total; $i++) {
				if ($procedencia==$v_status[$i]) echo "<option value='".$v_status[$i]."' selected>".utf8_encode($status[$i])."</option>";
				else echo "<option value='".$v_status[$i]."'>".utf8_encode($status[$i])."</option>";
			  }
			  break;		
	}
...
//	FUNCION PARA CARGAR LAS DEPENDENCIAS EN UN SELECT
function getDepDestinataria($opt, $dependencia) {
	connect();
	if ($opt==3 && $_SESSION["USUARIO_ACTUAL"]==$_SESSION["SUPER_USUARIO"]) $opt=0;
	switch ($opt) {
		case 0:
		     $sconsulta="select 
			              ...
			              from 
						       usuarios u 
							   inner join mastempleado me on (u.CodPersona = me.CodPersona) 
						 where 
			...
			$sql="SELECT CodDependencia, Dependencia FROM mastdependencias WHERE CodOrganismo='".$_SESSION['ORGANISMO_ACTUAL']."' AND CodDependencia = '".$fconsulta[1]."' ORDER BY CodDependencia";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
		...
		case 1: 
            ...
            $fconsulta=mysql_fetch_array($qconsulta);
			/// ---------------------------------------------------------------------------------
			$scon = "select max(Secuencia) from rh_empleadonivelacion where CodPersona = '".$fconsulta['CodPersona']."'"; //echo "<option>$scon</option>";
			...
			$sql = "SELECT
					...
					FROM
						  ...
						  inner join  mastdependencias mdep on (mdep.CodOrganismo=rhn.CodOrganismo)and(mdep.CodDependencia=rhn.CodDependencia)
					where
						 rhn.CodPersona = '".$fconsulta['CodPersona']."' and
						 rhn.Secuencia = '".$fcon['0']."' and 
						 rhn.CodOrganismo = '".$_SESSION['ORGANISMO_ACTUAL']."'"; //echo "<option>$sql/</option>";
			$query = mysql_query($sql) or die ($sql.mysql_error());
			/// ---------------------------------------------------------------------------------
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field['CodDependencia']==$dependencia) echo "<option value='".$field['CodDependencia']."' selected>".utf8_encode($field['Dependencia'])."</option>"; 
				else echo "<option value='".$field['CodDependencia']."'>".utf8_encode($field['Dependencia'])."</option>";
			}
		break;	
	}
}
//// -------------------------------------------------------------------------------------
//// FUNCION PARA OBTENER PARTICULAR DESTINATARIO
//// -------------------------------------------------------------------------------------
function getParticularDestinatario($opt, $particular){
connect();
  
   switch($opt){
      case 0:
	        $sql="select CodParticular, Nombre from cp_particular order by Nombre asc";
			$qry=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($qry);
            for($i=0; $i<$rows; $i++){
			  $field=mysql_fetch_array($qry);
			  if($field[0]==$particular) echo"<option value='".$field[0]."' selected>".utf8_encode($field[1])."</option>";
			  else echo"<option value='".$field[0]."'>".utf8_encode($field[1])."</option>";
			}
			break;
   }
