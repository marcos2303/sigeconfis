...
?>
<form name="frmentrada" id="frmentrada" action="<?=$regresar?>.php?limit=0&accion=guardarAcuseRecibo" method="post" >
...
echo"<input type='hidden' id='cod_documento' name='cod_documento' value='".@$fa['Cod_Documento']."'/>
	 ...
	 <input type='hidden' id='fEstado' name='fEstado' value='".@$_POST['fEstado']."'/> 
	 <input type='hidden' id='fDestinataria' name='fDestinataria' value='".@$_POST['fDestinataria']."'/> 
	 <input type='hidden' id='fProcedencia'  name='fProcedencia' value='".@$_POST['fProcedencia']."'/> 
	 <input type='hidden' id='fTdocumento'   name='fTdocumento' value='".@$_POST['fTdocumento']."'/> 
	 <input type='hidden' id='fDestinataria' name='fDestinataria' value='".@$_POST['fDestinataria']."'/> 
	";
?>
<tr>
...
<?php
  if($fa['Procedencia']=='INT'){
	...
	$sconsulta = "select * from cp_documentointerno where Cod_DocumentoCompleto = '$cod_documento'";
...
<tr>
 ...
 <td><input type="text" id="repre_remitente" name="repre_remitente" size="60" value="<?=$fdatos['NomCompleto']?>" readonly/></td>
</tr>
<tr>
 <td class="tagForm">Cargo:</td>
 <td><input type="text" id="cargo_remitente" name="cargo_remitente" size="60" value="<?=$fdatos['DescripCargo']?>" readonly/></td>
</tr>
...
<tr>
 ...
 <td><input name="nomempleado" id="nomempleado" type="text" size="52" value="<?=$fu['NomCompleto']?>" readonly/>
 </td>
