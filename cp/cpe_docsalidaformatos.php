...
<body>
<?
   list($cod_tipodocumento, $cod_documentocompleto, $periodo)=SPLIT( '[|]', $_GET['registro']);
   list($valor_a, $valor_b, $valor_c)=split('[-]', $cod_documentocompleto);
   $sa = "select 
               cps.FechaDocumento,
			   cps.Contenido,
			   cpd.Cod_Organismos,
		  ...
		  from 
			   ...
			   inner join cp_documentodistribucionext cpd on (cps.CodOrganismo = cpd.CodOrganismo)and(cps.Periodo=cpd.Periodo)and(cpd.Cod_Documento='$valor_b')
          where 
		       cps.Cod_DocumentoCompleto = '$cod_documentocompleto' and 
			   cps.Cod_TipoDocumento = '$cod_tipodocumento' and 
			   cps.Periodo='$periodo'";
...
<tr><td width="707">
  ...
  <tr>
   ...
   <tr>
      <td align="center"><font size="3"><i><?=ucwords(strtolower('CONTRALOR&Iacute;A DEL ESTADO DELTA AMACURO'))?></i></font></td>
   </tr>
   <tr>
...
<tr><td>
   ...
   <tr>
    ...
    <td width="4"></td>
    <td width="431"></td>
    <td width="210" align="right">Tucupita, <?=$d;?> de <?=$mes;?> de <?=$a;?></td>
   </tr>
   <tr>
    <td></td>
    <td></td>
...
<tr><td>
  ...
  <table id="cuerpo1" cellpadding="0" cellspacing="0">
    <tr>
      <td width="80"></td>
      <td width="351" style="text-align:justify"><b>Oficio N°: <?=$fa['Cod_DocumentoCompleto']?></b></td>
    </tr>
    <tr>
      <td width="80"></td>
      <td width="351"></td>
