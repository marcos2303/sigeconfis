...
echo "<input type='hidden' id='hidden' value='".$fEstado."'/>";
$filtro = "";
...
<tr>
 ...
 <td>
    <input type='checkbox' id='checkDestinataria' name='checkDestinataria' value='1' $cDestinataria onclick='this.checked=true'/>
	 <select id='fDestinataria' name='fDestinataria' class='selectBig'>";
	...
	for ($i=0; $i<$rows; $i++) {
	  ...
	  if($field['Procedencia']=='EXT'){
		...
		<tr class='trListaBody' onclick='mClk(this, \"registro\");' id='$id'>
			...
			<td align='left'>".$fdist['Dependencia']."</td>
			<td align='center'>".$fdist['NomCompleto']."</td>
			<td align='left'>".$fdist['DescripCargo']."</td>
