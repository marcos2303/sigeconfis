...
list($cod_tipodocumento, $cod_documentocompleto)= preg_split('/[|]/',$_GET['registro']);
 ...
 $year=date("Y");
 $scon="select * from cp_documentoextsalida where Cod_DocumentoCompleto='$cod_documentocompleto' and Cod_TipoDocumento='$cod_tipodocumento'";
...
<table class="tblForm" width="895px" border="0">
  ...
  <tr>
	...
	<?php if(isset($fcon['FechaRegistro']) and $fcon['FechaRegistro'] != '') {  list($a, $m, $d)=preg_split( '/[.-]/', $fcon['FechaRegistro']); $f_registro=$d.'-'.$m.'-'.$a;}?>
      ...
      <table width="800px" class="tblLista">
	   ...
	   $sdisext="select * from 
	                     ...
	                     where 
							   ...
							   Periodo ='".$fcon['Periodo']."' and Cod_TipoDocumento='".$fcon['Cod_TipoDocumento']."'";
