...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Lista Documentos Entrada</td>
...
if (@$fremitente !=""){ $filtro .="AND (Cod_Organismos= '".$fremitente."')"; $cRemitente = "checked";}else $dRemitente = "disabled"; 
if (@$DepRemitente !=""){ $filtro .="AND (Cod_Dependencia='".$DepRemitente."')"; $cDepRemitente="checked";} else $dDepRemitente="disabled";
...
echo "
<form name='frmentrada' id='frmentrada' method='post' action='rp_entradadocumentoslistapdf.php' target='reporte'>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroDocumentosEntrada(this.form, 0);'></center>
