...
function Cabecera($pdf,$valor) {
	...
	$pdf->SetXY(20, 17); $pdf->Cell(180, 5, utf8_decode('Contraloría del Estado Delta Amacuro'), 0, 1, 'C');
...
foreach ($trabajadores as $persona) {
	...
	$s="select * from cp_documentoextsalida where Cod_DocumentoCompleto='".$persona."' ";
	...
	while ($field = mysql_fetch_array($query)) {
		...
		$pdf->SetFont('Arial', 'B', 12);
		$pdf->SetXY(25, 170); $pdf->Cell(170, 10, $pie1, 0, 1, 'C');
