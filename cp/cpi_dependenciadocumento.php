...
<tr><td width="707">
  ...
  <tr>
   ...
   <td width="378"><p align="center" style=""><font size="2">REPUBLICA BOLIVARIANA DE VENEZUELA</font></p>
                   <p align="center"><font size="2">CONTRALORIA DEL ESTADO DELTA AMACURO</font></p>
...
<tr><td>
   <table width="695" height="27" id="numero_doc"> 
  <tr>
...
<tr><td>
  ...
  <tr>
    ...
    <td width="528"><?=$fd['Dependencia']?></td>
  </tr>
    <tr>
    <td width="80"></td>
    <td width="48"></td>
    <td width="528"><?=$fd['NomCompleto']?></td>
  </tr>
  <tr>
    <td></td>
    <td><b>De:</b></td>
