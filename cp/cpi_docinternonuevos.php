...
<tr>
  ...
  <td width="320">
	<?php 
		if(!isset($fEstado)) $fEstado = "";
		if(!isset($fremitente)) $fremitente = "";
	?>
     <?php 
...
<tr>
  ...
  <td><textarea name="anexDescp" id="anexDescp" rows="2" cols="80" style="visibility:hidden">Introduzca Descripción del anexo...</textarea></td>
</tr>
<tr><td height="5"></td></tr>
<tr>
...
<tr><td height="5"></td></tr>
 <tr>
    ...
    <td colspan="2"><select id="organismo" name="organismo" class="selectBig" onchange="getOrganismoInterno(this.id, 'dep_interna');" >
      <option value=""></option>
      <? getOrganismos('', 0); ?>
    </select>*</td>
    <td><input type="checkbox" id="encarg_especial" name="encarg_especial" onclick="botonCargo(this.form);"/> Encargadur&iacute;a Especial</td>
  </tr>
  <tr>
    <td class="tagForm" colspan="">Dependencia:</td>
    <td colspan="3">
        <select id="dep_interna" name="dep_interna" class="selectBig" disabled>
            <option value=""></option>
        </select>*</td>
  </tr>
  <tr>
    ...
    <td>
        <input type="text" id="cargodestinatario_int" name="cargodestinatario_int" size="68" value="" readonly="readonly"/>
        ...
        <input type="hidden" id="codigo_cargo" name="codigo_cargo" value=""/>
        <input type="button" id="btCargoDest" name="btCargoDest" value='Cargo' onclick="cargarVentana(this.form,'lista_cargos.php?limit=0&ventana=insertarCargos&Activar=D&codigo_cargo=codigo_cargo', 'height=600, width=800, left=50, top=50, resizable=yes');" style="visibility:hidden;"/>
    </td>
  </tr>
<tr><td height="5"></td></tr>
<tr>
...
<tr>
  ...
  <table width="800" class="tblBotones">
   <tr>
 	<td align="right">
    <input type="button" class="btLista" id="btCargo" name="btCargo" value="Cargo" onclick="Verificar()|cargarVentana(this.form,'lista_cargos.php?limit=0&ventana=insertarCargos&tabla=item&id_descp_cargo='+document.getElementById('id_descp_cargo').value+'&id_cargo='+document.getElementById('id_cargo').value, 'height=600, width=800, left=50, top=50, resizable=yes');" style="visibility:hidden;"/>
    <input type="button" class="btLista" id="btInsertarDependencia" value="Ins. Dep." onclick="Verificar()|cargarVentana(this.form,'lista_dependencias.php?limit=0&ventana=insertarDestinatarioDep&tabla=item&frmdetalles=frmdetalles&contador='+document.getElementById('contador').value, 'height=600, width=800, left=50, top=50, resizable=yes');" />
  ...
  <td valign="top" style="height:150px; width:800px;">
    ...
    <tr>
      ...
      <table width="800px" class="tblLista">
       <tr>
         <th width="200" class="trListaHead">Dependencia</th>
        <th width="200" class="trListaHead">Representante/Empleado</th>
        <th width="200" class="trListaHead">Cargo</th>
        </tr>
