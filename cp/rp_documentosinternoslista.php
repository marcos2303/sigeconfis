...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Lista Documentos Internos</td>
...
$MAXLIMIT=30;
echo "
<form name='frmentrada' action='rp_documentosinternoslistapdf.php' method='POST' target='reporte'>
...
<tr>
 <td align='right'>Dep. Destinataria:</td>
 <td><input type='checkbox' id='checkDestinataria' name='checkDestinataria' value='1' $cDestinataria onclick='enabledDepDestinataria(this.form);'/>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroDocumentoInternoRP(this.form, 0);'></center>
