...
function mClk(src, registro) {
	...
	var registro=document.getElementById(registro); //alert(registro);
...
//// ---------------------------------------------------------------------------------------------
////  FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES CPE_ENTRADA.PHP
function totalRegistrosNEV(rows, admin, insert, update, del) {
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	var btNuevo=document.getElementById("btNuevo");
	var btEditar=document.getElementById("btEditar");
...
//// ------------------------------------------------------------------------------------------------------
////  FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES CPI_DOCINTERNOSLISTA.PHP
function totalRegistrosNEVEMI(rows, admin, insert, update, del) {
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	var btNuevo=document.getElementById("btNuevo");
	var btEditar=document.getElementById("btEditar");
	var btVer=document.getElementById("btVer");
	var btEliminar=document.getElementById("btEliminar");
	var btModifRest = document.getElementById("btModifRest");
...
//// ------------------------------------------------------------------------------------------------------
////  FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES CPI_DOCINTERNOSPRE.PHP
function totalRegistrosDocIntPrep(rows, admin, insert, update, del) {
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	var btContenido=document.getElementById("btContenido");
	var btVer=document.getElementById("btVer");
	
	if (!rows) btContenido.disabled=true;
	if (!rows) btVer.disabled=true;
}
//// ------------------------------------------------------------------------------------------------------
////  FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES CPI_DOCINTERNOSENVIO.PHP
function totalRegistrosDocIntEnv(rows, admin, insert, update, del) {
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	var btEnvio=document.getElementById("btEnvio");
	
	if (!rows) btEnvio.disabled=true;
}
//// ------------------------------------------------------------------------------------------------------
//// FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES CPI_DOCINTERNOSDIST.PHP
function totalRegistrosDocIntDist(rows, admin, insert, update, del){
 var numreg = document.getElementById("rows");
     numreg.innerHTML = "Registros:"+rows;
 var btImprimir = document.getElementById("btImprimir");
...
//// ------------------------------------------------------------------------------------------------------
////  FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES CPE_SALIDALISTA.PHP
function totalRegistrosSalista(rows, admin, insert, update, del) {
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	var btNuevo=document.getElementById("btNuevo");
	var btEditar=document.getElementById("btEditar");
	...
	if (insert=="N") btNuevo.disabled=true;
	if (update=="N" || !rows){ btEditar.disabled=true; btModifRest.disabled=true;}
	if (!rows) btVer.disabled=true;
	if (del=="N"|| !rows)btAnular.disabled=true; // Anular
	if (!rows) btImprimir.disabled=true; 
}
//// FUNCION TOTAL REGISTRO / DESBLOQUEA OPCIONES DE BOTON
function totalRegistrosDocumentoInternoListas(rows, admin, insert, update, del) { 
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	var btNuevo=document.getElementById("btNuevo");
	var btEditar=document.getElementById("btEditar");
...
//// ------------------------------------------------------------------------------------------------------
////  FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES CPE_SALIDAPREPARAR.PHP
function totalRegistrosSalPre(rows, admin, insert, update, del) {
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	var btContenido=document.getElementById("btContenido");
	var btVer=document.getElementById("btVer");
...
//	FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES
function totalRegistrosAtender(rows, admin, insert, update, del) {
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	var btVer=document.getElementById("btVer");
	var btAtender=document.getElementById("btAtender");
	
	if (insert=="N") btAtender.disabled=true;
	if (!rows) btVer.disabled=true;
}
//	FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES
...
/// -------------------------------------------------------------------------------- ///
function eliminarTseguros(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp_ajax.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARTS&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
function selEmpleado(busqueda, campo, variable, otro1, otro2, otro3) { //alert('paso');
	...
	if (campo==1) {
		...
		opener.document.frmentrada.nomempleado.value=busqueda;//alert(opener.document.frmentrada.nomempleado.value);
		opener.document.frmentrada.cargoremitente.value=variable; //alert(opener.document.frmentrada.cargoremitente.value);
	}
	else if (campo == 2) {
		...
		opener.document.frmentrada.codempleado.value=registro;
		opener.document.frmentrada.nomempleado.value=busqueda;//alert(opener.document.frmentrada.nomempleado.value);
		opener.document.frmentrada.cargoremit.value=variable; //alert(opener.document.frmentrada.cargoremit.value);
		opener.document.frmentrada.cod_cargoremit.value=otro1; //alert(opener.document.frmentrada.cargoremit.value);
	}else if (campo == 5) {
		opener.document.frmentrada.codempleado.value=registro;
		opener.document.frmentrada.nomempleado.value=busqueda;///alert(opener.document.frmentrada.nomempleado.value);
		opener.document.frmentrada.cargoremit.value=variable; //alert(opener.document.frmentrada.cargoremit.value);
	}else if (campo == 6){
	   opener.document.frmentrada.codParticular.value=registro;
	   opener.document.frmentrada.nombreParticular.value=busqueda;///alert(opener.document.frmentrada.nomempleado.value);
	   opener.document.frmentrada.p_cargo.value=variable; //alert(opener.document.frmentrada.cargoremit.value);
	   opener.document.frmentrada.p_cedula.value=otro1;
	   opener.document.frmentrada.p_direccion.value=otro2;
	   opener.document.frmentrada.p_telefono.value=otro3;
	   opener.document.frmentrada.p_nombre.value=busqueda;
...
/// ________________________________________________________________________________
function ActivarParticular(form){ //alert('paso');
 if(form.activar.checked){  form.codParticular.disabled=false;  
							form.bt_examinar2.disabled=false;
							form.p_cedula.disabled=false;
							form.p_direccion.disabled=false; 
							form.p_telefono.disabled=false;  
							form.p_cargo.disabled=false; 
 							
							form.organismo.disabled=true; form.organismo.value="";
							form.remitente_ext.disabled=true; form.remitente_ext.value="";
							form.cargoremitente_ext.disabled=true; form.cargoremitente_ext.value = "";
							form.dep_externa.disabled= true; form.dep_externa.value="";
							form.activarOrg.checked = false;
							form.activar.checked = true;
 }
}
////--------------------------------------------------------------------------------
function enabledParticularDestinatario(form){
  if(form.checkPartDest.checked) form.fPartDest.disabled=false;
  else{ form.fPartDest.disabled=true; form.fPartDest.value="";}
}
////--------------------------------------------------------------------------------
function ActivarOrganismo(form){
if(form.activarOrg.ckecked){
							form.codParticular.disabled=true;  form.codParticular.value=""; 
							form.bt_examinar2.disabled=true; 
							form.p_cedula.disabled=true;  form.p_cedula.value="";
							form.p_direccion.disabled=true;  form.p_direccion.value="";
							form.p_telefono.disabled=true; form.p_telefono.value="";  
							form.p_cargo.disabled=true; form.p_cargo.value="";
 							
							form.organismo.disabled=false; 
							form.remitente_ext.disabled=false;
							form.cargoremitente_ext.disabled=false;
							form.dep_externa.disabled= false;
							form.activar.checked = false;
							form.activarOrg.checked = true;
...
function enabledProcedencia(form){
  if(form.checkProcedencia.checked) form.fProcedencia.disabled=false;
  else{ form.fProcedencia.disabled=true; form.fProcedencia.value="";}
}
function enabledDepRemitente(form){
  if(form.checkDepRemitente.checked) form.DepRemitente.disabled=false;
  else{ form.DepRemitente.disabled=true; form.DepRemitente.value="";}
}

function enabledFechaRecibido(form){
	if (form.checkFechaRecibido.checked) {form.fdesde.disabled=false; form.fhasta.disabled=false;} 
	else{ form.fdesde.disabled=true; form.fhasta.disabled=true; form.fhasta.value=""; form.fdesde.value="";} 
}
function enabledFechaEnviado(form){
	if (form.checkFechaEnviado.checked) {form.fdesde.disabled=false; form.fhasta.disabled=false;} 
	else{ form.fdesde.disabled=true; form.fhasta.disabled=true; form.fhasta.value=""; form.fdesde.value="";} 
}
function enabledRemitente(form){
	if (form.checkRemitente.checked) form.f_Remitente.disabled=false;
	else {form.f_Remitente.disabled=true; form.f_Remitente.value="";} 
}  
function enabledOrdenarDocumento(form){
  if (form.chkOrdenarDoc.checked) form.fordenardoc.disabled=false;
  else {form.fordenardoc.disabled=true; form.fordenardoc.value="";} 
}
...
function enabledDestinatario(form){
 if(form.checkDestinatario.checked) form.fDestinatario.disabled=false;
 else {form.fDestinatario.disabled=true; form.fDestinatario.value="";}
}
function enabledDestinatarioSailda(form){
 if(form.checkDestinatario.checked) form.fDestinatario.disabled=false;
 else {form.fDestinatario.disabled=true; form.fDestinatario.value="";}
}
function enabledenabledcoord_con(form){
 if(form.coord_con.checked) form.coord_con2.disabled=false;
 else {form.coord_con2.disabled=true; form.coord_con2.value="";}
}
function enabledRegistrode(form){
 if(form.registro_de.checked) form.registro_de2.disabled=false;
 else {form.registro_de2.disabled=true; form.registro_de2.value="";}
}
function enabledPrememo(form){
 if(form.pre_memo.checked) form.pre_memo2.disabled=false;
 else {form.pre_memo2.disabled=true; form.pre_memo2.value="";}
}
function enabledPrepoficio(form){
 if(form.prep_oficio.checked) form.prep_oficio2.disabled=false;
 else {form.prep_oficio2.disabled=false; form.prep_oficio2.value="";}
}
function enabledTramdias(form){
 if(form.tram_dias.checked) form.tram_dias2.disabled=false;
 else {form.tram_dias2.disabled=true; form.tram_dias2.value="";}
}
function enabledFechaElaborado(form){
 if(form.checkFechaElaborado.checked) form.fechaElaborado.disabled=false;
 else {form.fechaElaborado.disabled=true; form.fechaElaborado.value="";}
}
...
//// TIPO DOCUMENTO
function enabledTdocumento(form){
 if(form.checkTdocumento.checked) form.fTdocumento.disabled=false;
 else {form.fTdocumento.disabled=true; form.fTdocumento.value="";}
}
function enabledDestinatarioDocInt(form){
 if(form.checkDestinatario.checked)	form.fDestinatario.disabled=false;
 else {form.fDestinatario.disabled=true; form.fDestinatario.value="";}
}
function enabledFechaCreado(form){
 if(form.checkFechaCreado.checked) form.fechaCreado.disabled=false;
 else {form.fechaCreado.disabled=true; form.fechaCreado.value="";}
}
...
/// ******************************************************************************** ///
/// ELIMINAR TIPO DE CORRESPONDENCIA
/// ******************************************************************************** ///
function eliminarTcorrespondencia(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp_ajax.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARCOR&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
/// ELIMINAR TIPO DE CORRESPONDENCIA
/// ******************************************************************************** ///
function eliminarParticular(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp_ajax.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARPARTICULAR&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
/// ******************************************************************************** ///
function obt_Valor(){
  var valor = document.getElementById("ente").value; //alert('valor= '+valor);
      document.getElementById("entes").value= valor; //alert('document.getElementById("entes").value='+document.getElementById("entes").value)
}
//// -----------------------------------------------------------------------------------
//	FUNCION PARA INSERTAR A QUIEN VA DIRIGIDO EL DOCUMENTO " MODULO DE CORRESPONDENCIA"
//// -----------------------------------------------------------------------------------
function insertarDestinatarioEmp(codigo, accion) { //alert('Pasasssss');
	...
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=insertarDestinatarioEmp&codigo="+codigo+"&ventana="+ventana+"&tabla="+tabla+"&detalles="+detalles);
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			var resp = ajax.responseText;
			var datos = resp.split("||");
...
//// ****** ------------------------------------------------------------------------
//	 FUNCION PARA CARGAR EN UN SELECT LO SELECCIONADO EN OTRO SELECT (2 SELECTS)
function getOptionsOrganismosExt(idSelectOrigen, idSelectDestino, idChkDestino) {
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	var chkDestino=document.getElementById(idChkDestino);
	if (optSelectOrigen=="") {
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getOptionsDep&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
...
//// *********************************************************************************
////                       FUNCIONES MODULO "CORRESPONDENCIA"
//// *********************************************************************************
//// FUNCION PARA CARGAR EN UN SELECT  
function getOptionsOrganismosExt2(idSelectOrigen, idSelectDestino, idChkDestino) {
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	var chkDestino=document.getElementById(idChkDestino);
	if (optSelectOrigen=="") {
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getOptionsDep2&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
...
//// *******************************************************************************
//// FUNCION PARA CARGAR EN UN SELECT  PARA DOCUMENTOS INTERNOS  *******************
//// ****** ------------------------------------------------------------------------
function getOptionsOrganismosInt(idSelectOrigen, idSelectDestino, idChkDestino) {
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	var chkDestino=document.getElementById(idChkDestino);
...
//// ****** ------------------------------------------------------------------------
//// ****** --FUNCION PARA OBTENER EL REPRESENTANTE LEGAL DEL ENTE U ORGANISMO------
//// ****** ------------------------------------------------------------------------
function getOptionsRepresentanteExt(idSelectOrigen, idSelectDestino, idChkDestino) {
	var organismo=document.getElementById("organismo").value; //alert('Org='+organismo);
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	var chkDestino=document.getElementById(idChkDestino);
	if (optSelectOrigen=="") {
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getOptionsRep&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
...
//// ****** ------------------------------------------------------------------------
//// ****** --FUNCION PARA OBTENER EL REPRESENTANTE DE LA DEPENDENCIA EXTERNA ******
//// ****** ------------------------------------------------------------------------
function getOptionsRepresentanteExt2(idSelectOrigen, idSelectDestino, idChkDestino){
	var organismo=document.getElementById("organismo").value; //alert('Org='+organismo);
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
...
//// ****** ------------------------------------------------------------------------
//// ****** --FUNCION PARA OBTENER EL REPRESENTANTE DE LA DEPENDENCIA INTERNA ******
//// ****** ------------------------------------------------------------------------
function getOptionRepresentanteDepInt(idSelectOrigen, idSelectDestino, idChkDestino){
	var organismo=document.getElementById("organismo").value; //alert('Org='+organismo);
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
...
//// ****** --FUNCION PARA OBTENER EL REPRESENTANTE LEGAL DEL ENTE U ORGANISMO------
//// ****** ------------------------------------------------------------------------
function getOptionsCargoRepExt(idSelectOrigen, idSelectDestino, idChkDestino) { //alert('aqui voy');
        alert(1);
	var organismo=document.getElementById("organismo").value; //alert('Org='+organismo);
	var dependencia=document.getElementById("dependencia").value; //alert('Dep='+dependencia);
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	var chkDestino=document.getElementById(idChkDestino);
	if (optSelectOrigen=="") {
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getOptionsCarg&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
...
//// ****** ------------------------------------------------------------------------
//// ****** ------------------------------------------------------------------------
function obtenerRemitente(idSelectOrigen, idSelectDestino, idSelectDestino2){ 
  var organismo = document.getElementById("organismo").value; //alert(organismo);
  var dependencia = document.getElementById("dependencia").value; //alert(dependencia);
      //document.getElementById("valor1").value=dependencia;
  
  var selectOrigen=document.getElementById(idSelectOrigen);
  var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
  
  var selectDestino=document.getElementById(idSelectDestino); //alert(selectDestino);
  var selectDestino2=document.getElementById(idSelectDestino2); //alert(selectDestino2);
 ...
 if (optSelectOrigen=="") {
        ...
        var ajax=nuevoAjax(); //alert('aqui1');
		ajax.open("POST", "fphp_selects.php", true);//alert('aqui2');
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");//alert('aqui3');
		ajax.send("accion=getObtRemit&tabla="+selectDestino+"&tabla2="+selectDestino2+"&organismo="+organismo+"&dependencia="+dependencia);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
...
//// ****** ------------------------------------------------------------------------
//// FUNCION OBTENER DEPEDENCIA INTERNA MODULO CORRESPONDENCIA
//// ****** ------------------------------------------------------------------------
function getOrganismoInterno(idSelectOrigen, idSelectDestino) {
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	if (optSelectOrigen=="") {
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getDepenInt&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
			...
			if (ajax.readyState==4)	{
				var resp = ajax.responseText;
				var datos = resp.split("|");
				selectDestino.parentNode.innerHTML = datos[0];
				document.getElementById("destinatario_int").value = datos[1];
				document.getElementById("cargodestinatario_int").value = datos[2];
				document.getElementById("codigo_interno").value = datos[3];
				document.getElementById("codigo_persona").value = datos[4];
				document.getElementById("codigo_cargo").value = datos[5];
			}
		}
	}
}

function getObtenerValor(organismo, dependencia) {
	//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
	var ajax=nuevoAjax();
	ajax.open("POST", "fphp_selects.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=getObtenerValor&organismo="+organismo+"&dependencia="+dependencia);
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			var resp = ajax.responseText;
			var datos = resp.split("|");
			document.getElementById("destinatario_int").value = datos[0];
			document.getElementById("cargodestinatario_int").value = datos[1];
			document.getElementById("codigo_interno").value = datos[2];
			document.getElementById("codigo_persona").value = datos[3];
			document.getElementById("codigo_cargo").value = datos[4];
		}
	}
}
//// ****** ------------------------------------------------------------------------
////  FUNCION OBTENER INFORMACION DE LOS REMITENTES EXTERNOS
//// ****** ------------------------------------------------------------------------
function getOrganismosExternos(idSelectOrigen, idSelectDestino) {
	var selectOrigen=document.getElementById(idSelectOrigen); 
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value; //alert(optSelectOrigen);
	var selectDestino=document.getElementById(idSelectDestino);
	if (optSelectOrigen=="") {
		selectDestino.length=0;
		nuevaOpcion=document.createElement("option");
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getDepenExterna&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
			...
			if (ajax.readyState==4)	{
				...
				var datos = resp.split("|");
				selectDestino.parentNode.innerHTML = datos[0];
				document.getElementById("remitente_ext").value = datos[1];
			    document.getElementById("cargoremitente_ext").value = datos[2];
			}
		}
	}
}

function getObtenerValorExterno(organismo, dependencia) { //alert(organismo); alert(dependencia);
	//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
	var ajax=nuevoAjax();
	ajax.open("POST", "fphp_selects.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=getObtenerValorExterno&organismo="+organismo+"&dependencia="+dependencia);
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			var resp = ajax.responseText;
			var datos = resp.split("|");
			document.getElementById("remitente_ext").value = datos[0];
			document.getElementById("cargoremitente_ext").value = datos[1];
		}
	}
}
//// ****** ------------------------------------------------------------------------
//// ****** ------------------------------------------------------------------------
function getDependenciaInt(idSelectOrigen, idSelectDestino, idChkDestino){
	var organismo=document.getElementById("organismo").value; //alert('Org='+organismo);
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	...
	if (optSelectOrigen=="") {
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getDestinatarioInt&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
...
//// ****** ------------------------------------------------------------------------
function getDestinatarioInt(idSelectOrigen, idSelectDestino, idChkDestino){
	var organismo=document.getElementById("organismo").value; //alert('Org='+organismo);
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	...
	if (optSelectOrigen=="") {
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getCargoDestinatarioInt&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
...
//// ****** ------------------------------------------------------------------------
//// *****************************************************************////
  // GUARDAR LOS DATOS " MODULO DE CORRESPONDENCIA"
//// *****************************************************************////
function guardarAtenderExt(form) {
	var organismo = document.getElementById("organismo").value;
	var dependencia = document.getElementById("dep_externa").value;
	var depenOrigen = document.getElementById("depenOrigen").value; //alert('DepenOrigen='+depenOrigen);
	var n_documento = document.getElementById("n_documento").value;
	var t_documento = document.getElementById("t_documento").value;
	var cod_documento = document.getElementById("cod_documento").value;
	var codparticular = document.getElementById("codParticular").value; //alert('CodParticular='+codparticular);
	var paginaIr = document.getElementById("paginaIr").value; //alert('PaginaIr='+paginaIr);
	var reg_interno = document.getElementById("reg_interno").value; //alert('RegistroInterno='+reg_interno);
	
	var checks = "";
	// obtengo los valores de las lineas insertadas
	var frmchecks = document.getElementById("frmchecks");
	for(i=0; n=frmchecks.elements[i]; i++) {
		if (n.type == "text") checks += n.id + "=" + n.value + "&";
		else if (n.type == "checkbox" && n.checked) checks += n.id + "=1" + "&"; else checks += n.id + "=0" + "&";
	}
	var len = checks.length; len--;
	checks = checks.substr(0, len);
	...
	if (error_detalles != "") alert(error_detalles);
		...
		ajax.open("POST", "gmcorrespondencia.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=guardarDestinatarios&detalles="+detalles+"&organismo="+organismo+"&dependencia="+dependencia+"&depenOrigen="+depenOrigen+"&cod_documento="+cod_documento+"&t_documento="+t_documento+"&n_documento="+n_documento+"&codparticular="+codparticular+"&reg_interno="+reg_interno+"&"+checks);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var resp = ajax.responseText;
...
//// ****** ------------------------------------------------------------------------
 // FUNCION QUE PERMITE GUARDAR NUEVO DOCUMENTO DE SALIDA - CORRESPONDENCIA
//// ****** ------------------------------------------------------------------------
function guardarSalidaExt(form) {  //alert('guardarSalidaExt');
	var organismo = document.getElementById("organismo").value;
	...
	//var EsParticular = document.getElementById("EsParticular").value;alert(EsParticular);
	...
	var frmdetalles = document.getElementById("frmdetalles");
	for(i=0; n=frmdetalles.elements[i]; i++) {
		if (n.name == "codigo_organismo") detalles += n.value + "|";
		if (n.name == "codigo_dependencia") detalles += n.value + "|";
		if (n.name == "EsParticular") detalles += n.value + "|";
		if (n.name == "representante") detalles += n.value + "|";
		if (n.name == "cargorepresentante") detalles += n.value + ";";
	}
	var len = detalles.length; len--;
	detalles = detalles.substr(0, len);
...
//// ---------------------------------------------------------------------------------------
  // FUNCION QUE PERMITE EDITAR DOCUMENTO DE SALIDA - CORRESPONDENCIA
//// ---------------------------------------------------------------------------------------
function guardarSalidaExtEditar(form){  //alert('guardarSalidaExtEditar');
	var organismo = document.getElementById("organismo").value;
	var dep_interna = document.getElementById("dep_interna").value;
	var n_documento = document.getElementById("n_documento").value;
	var t_documento = document.getElementById("t_documento").value;
...
//// ---------------------------------------------------------------------------------------
  // FUNCION QUE PERMITE INSERTAR UNA DEPENDENCIA EXTERNA " MODULO DE CORRESPONDENCIA"
//// ---------------------------------------------------------------------------------------
function insertarDestinatarioDepExt(codigo, accion) { //alert('Pasasssss');

    var cod = codigo.split("|");
	var cod1 = cod[0]; //alert('cod1='+cod1);
	var cod2 = cod[1]; //alert('cod2='+cod2);
	...
	ajax.open("POST", "gmcorrespondencia.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=insertarDestinatarioDepExt&cod2="+cod2+"&ventana="+ventana+"&tabla="+tabla+"&detalles="+detalles);
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			var resp = ajax.responseText;
			var datos = resp.split("||");
...
//// ---------------------------------------------------------------------------------------
  // FUNCION QUE PERMITE INSERTAR UN ORGANISMO EXTERNO " MODULO DE CORRESPONDENCIA"
//// ---------------------------------------------------------------------------------------
function insertarDestinatarioOrgExt(codigo, accion) { //alert('Pasasssss');
    var ventana = document.getElementById("ventana").value; //alert(ventana);
	var tabla = document.getElementById("tabla").value; //alert(tabla);
	var form = opener.document.getElementById("frmdetalles");
	var detalles = ""; //alert(codigo);
	...
	ajax.open("POST", "gmcorrespondencia.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=insertarDestinatarioOrgExt&codigo="+codigo+"&ventana="+ventana+"&tabla="+tabla+"&detalles="+detalles);
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			var resp = ajax.responseText;
			var datos = resp.split("||");
...
//// ---------------------------------------------------------------------------------------
  // FUNCION PARA ELIMINAR UN REGISTRO DE LA BASE DE DATOS - TABLA CP_DOCUMENTOEXTENTRADA 
  // FUNCION QUE PERMITE INSERTAR UN ORGANISMO EXTERNO " MODULO DE CORRESPONDENCIA"
//// ---------------------------------------------------------------------------------------
function eliminarRegistroEntradaExterna(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp_ajax.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARDOCUMENTOEXTERNO&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
//// ---------------------------------------------------------------------------------------
  ...
  // FUNCION QUE PERMITE INSERTAR UN ORGANISMO EXTERNO " MODULO DE CORRESPONDENCIA"
//// ---------------------------------------------------------------------------------------
function eliminarRegistroSalidaExterna(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp_ajax.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARDOCUMENTOSALIDAEXTERNA&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
//// ------------------------------------------------------------------------------------------
//// ANULAR REGISTRO, CAMBIA ESTADO DE LOS REGISTROS DE SALIDA DE DOCUMENTOS EN CORRESPONDENCIA
//// ------------------------------------------------------------------------------------------
function AnularRegistroSalidaExterna(form, pagina, foraneo, modulo){ 
var codigo=form.registro.value; //alert('Paso Codigo2='+codigo);
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (anular) {
			if (foraneo){
				...
				ajax.open("POST", "fphp_ajax.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=AnularRegistroSalidaExterna&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
//// ------------------------------------------------------------------------------------------
//// ANULAR REGISTRO, CAMBIA ESTADO DE LOS DOCUMENTOS INTERNOS EJEMPLO MEMORANDUM EN CORRESPONDENCIA
//// ------------------------------------------------------------------------------------------
function AnularRegistroInterno(form, pagina, foraneo, modulo){
	...
	if (codigo=="") msjError(1000);
		...
		if (anular) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp_ajax.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=AnularRegistroInterno&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
//// ---------------------------------------------------------------------------------------
  // FUNCION QUE PERMITE INSERTAR UN PARTICULAR " MODULO DE CORRESPONDENCIA"
//// ---------------------------------------------------------------------------------------
function insertarDestinatarioParticularExt(codigo, accion){

    var cod = codigo.split("|");
	var codigo1 = cod[0]; //alert('cod1='+codigo1);
	var codigo2 = cod[1]; //alert('cod2='+codigo2);
	...
	ajax.open("POST", "gmcorrespondencia.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=insertarDestinatarioParticularExt&codigo="+codigo2+"&ventana="+ventana+"&tabla="+tabla+"&detalles="+detalles);
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			var resp = ajax.responseText;
			var datos = resp.split("||");
...
//// ---------------------------------------------------------------------------
//// FUNCION PARA ASIGNAR DATOS DE ENVIO DEL DOCUMENTO DE SALIDA 
//// ---------------------------------------------------------------------------
function cargarEnvio(form) {
	var fEstado = document.getElementById("fEstado").value; //alert('='+fEstado);
	var detalles = "";
	...
	else window.open("cpe_salidaenviolisto.php?detalles="+detalles+"&formulario="+form.id+"&fEstado="+fEstado, '_self'); 
}
//// ---------------------------------------------------------------------------
//// FUNCION PARA ASIGNAR DATOS DE ENVIO DEL DOCUMENTO INTERNO
//// ---------------------------------------------------------------------------
function cargarEnvioInterno(form) {
	var detalles = "";
	var fremitente = document.getElementById("fremitente").value; //alert('fremitente='+fremitente);
	...
	if (detalles == "") alert("¡Debe seleccionar por lo menos un detalle!");
	else window.open("cpi_enviolisto.php?detalles="+detalles+"&fremitente="+fremitente+"&formulario="+form.id, '_self'); 
}
//// ---------------------------------------------------------------------------
//// FUNCION PARA MOSTRAR DOCUMENTO SALIDA ENVIO
//// ---------------------------------------------------------------------------
function cargarDocumentoEnvioSalida(form) {
	var detalles = "";
	...
	if (detalles == "") alert("¡Debe seleccionar por lo menos un detalle!");
	else window.open("cpe_salidadocumento.php?detalles="+detalles+"&formulario="+form.id, '_blank','height=580, width=850, left=200, top=70'); 
}
//// ---------------------------------------------------------------------------
//// ---------------------------------------------------------------------------
function guardarEnvio(form){
  ...
  if (error_detalles != "") alert(error_detalles);
		...
		ajax.open("POST", "gmcorrespondencia.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=guardarEnvio&detalles="+detalles+"&ndoc_completo="+ndoc_completo+"&t_documento="+t_documento+"&periodo="+periodo+"&codempleado="+codempleado+"&cod_cargoremit="+cod_cargoremit);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var resp = ajax.responseText;
				//if (resp != "") alert(resp.trim());
...
//// ---------------------------------------------------------------------------
function cargarOpcionModifRest(form, pagina, target, param) {
	var codigo=form.registro.value;
	...
	if (codigo=="") msjError(1000);
		...
		if(status=="PP"){
	        ...
	        alert('El Estado del Documento impide la acción...!');	
	    }
    }
}
//// ---------------------------------------------------------------------------
//// FUNCION PARA EDITAR REGISTRO DE DOCUMENTO DE PROCEDENCIA EXTERNA
//// SIEMPRE QUE TENGA COMO ESTADO PENDIENTE "PE"
//// ---------------------------------------------------------------------------
function cargarOpcionEditarExtEntrada(form, pagina, target, param) {
	var codigo=form.registro.value;
	...
	if (codigo=="") msjError(1000);
		...
		if(status=="PE"){
	        ...
	        alert('El Documento no puede ser editado..!');	
	    }
    }
}
//// ---------------------------------------------------------------------------
//// EDITAR DOCUMENTO INTERNO SIEMPRE QUE ESTADO SEA DISTINTO DE ENVIADO 
//// Y RECICIBIDO
//// ---------------------------------------------------------------------------
function cargarOpcionEditarDocInterno(form, pagina, target, param) {
	var codigo=form.registro.value;
	
	if (codigo=="") msjError(1000);
	else{
		var status = document.getElementById("status").value; //alert('status='+status);
		if((status=="PP")||(status=="PR")){
			if (target=="SELF") cargarPagina(form, pagina);
			else { pagina=pagina+"?limit=0&accion=VER&registro="+codigo; cargarVentana(form, pagina, param); }
		}else{
	        alert('El Documento no puede ser editado..!');	
...
//// ---------------------------------------------------------------------------
//// CONDICIONES PARA APLICAR ACUSE DE RECIBO
function CargarAcuseDepRecibidos(form, pagina, target, param) {
	var codigo=form.registro.value;
	...
	if (codigo=="") msjError(1000);
		...
		if(((status=="EV")&&(procedencia=="EXT"))||((status=="EV")&&(procedencia=="INT"))){
			if (target=="SELF") cargarPagina(form, pagina);
			else { pagina=pagina+"?limit=0&accion=VER&registro="+codigo; cargarVentana(form, pagina, param); }
		}else{
	        alert('El Documento ya ha recibido acuse...!');	
	    }
    }
}
//// ---------------------------------------------------------------------------
////
function CargarOpcionEditDocSalida(form,pagina, target, param){
  var codigo = form.registro.value;
...
//// ------------------------------------------------------------------------------
////
function cargarOpcionDocumentoSalida(form, pagina, target, param){
 var codigo = form.registro.value;
