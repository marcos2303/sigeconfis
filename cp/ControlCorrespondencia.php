...
if(@$accion=='EditarEntradaExterna'){
 ...
 $qry=mysql_query($sql) or die ($sql.mysql_error());
	...
	if(!isset($_POST['t_documento'])) $_POST['t_documento'] = '';
	if(!isset($_POST['n_documento'])) $_POST['n_documento'] = '';
	if(!isset($_POST['codParticular'])) $_POST['codParticular'] = '';
	if(!isset($_POST['dep_externa'])) $_POST['dep_externa'] = '';
	if(!isset($_POST['remitente_ext'])) $_POST['remitente_ext'] = '';
	if(!isset($_POST['cargoremitente_ext'])) $_POST['cargoremitente_ext'] = '';
	if(!isset($_POST['codempleado'])) $_POST['codempleado'] = '';
	if(!isset($_POST['cod_cargoremit'])) $_POST['cod_cargoremit'] = '';
	if(!isset($_POST['descripcion'])) $_POST['descripcion'] = '';
	if(!isset($_POST['folio'])) $_POST['folio'] = '';
	if(!isset($_POST['anexofolio'])) $_POST['anexofolio'] = '';
	if(!isset($_POST['descpfolio'])) $_POST['descpfolio'] = '';
	if(!isset($_POST['nro_carpeta'])) $_POST['nro_carpeta'] = '';
	if(!isset($_POST['mensajero'])) $_POST['mensajero'] = '';
	if(!isset($_POST['ci_mensajero'])) $_POST['ci_mensajero'] = '';
	if(!isset($_POST['numero_registro'])) $_POST['numero_registro'] = '';
...
if(@$accion == @guardarContenido){
   list($d,$m,$a)=preg_split('/[.-]/',$_POST['fecha_documento']);$fecha_documento=$a.'-'.$m.'-'.$d;
...
list($d,$m,$a)=preg_split('/[.-]/',@$_POST['fecha_devolucion']); $fecha_devolucion=$a.'-'.$m.'-'.$d;
