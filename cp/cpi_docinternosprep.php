...
if(!isset($_POST['fremitente'])) $fremitente = $_SESSION["FILTRO_DEPENDENCIA_ACTUAL"]; else{ $fremitente = $_POST['fremitente']; $cRemitente = "checked"; }
...
if(!isset($_INSERT)) $_INSERT = ''; 
if(!isset($_UPDATE)) $_UPDATE = ''; 
if(!isset($_DELETE)) $_DELETE = ''; 
echo "
