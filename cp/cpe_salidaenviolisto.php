...
<?php
  ...
  foreach ($det as $detalle) {
	@list($cod_documento, $periodo, $secuencia, $tipo_documento, $CodOrganismo)=preg_split( '/[|]/', $detalle);$i++;
...
<tr>
   ...
   <tr>
     ...
     <td width="122" class="tagForm">Fecha Documento:</td>
         <? 
           list($a,$m,$d)=preg_split('/[.-]/',@$field[1]);$f_documento=$d.'-'.$m.'-'.$a; 
         ?>
 ...
 <tr>
   ...
   <table class="tblForm" width="425px">
    ...
    <td><input name="coddependencia" type="hidden" id="coddependencia" value="<?=$field[5]?>"/>
	   <input name="dependencia" id="dependencia" type="text" size="68" value="<?=$field[4]?>" readonly/></td>
    </tr>
    <tr>
      <td class="tagForm">Representante:</td>
      <td><input name="codpersona" type="hidden" id="codpersona" value="<?=$_POST['registro']?>"/>
	 <input name="nomb_remitente" id="nomb_remitente" type="text" size="68" value="<?=$field[6]?>" readonly/></td>
    </tr>
    <tr>
   ...
   <table class="tblForm" width="435px">
    <tr>
      ...
      <table width="435px" class="tblLista">
	   ...
	   foreach ($det as $detalle) {
		   @list($cod_documento, $periodo, $secuencia)=preg_split( '/[|]/', @$detalle);$i++;
           //echo"$cod_documento, $periodo, $secuencia";	
