...
<tr>
   ...
   <td width="309"><?
				   ...
				   ?>
                   <select id="select_categoria" class="selectSma" onchange="cargarCampoCategoria(this.id)" style="width:60px;" disabled>
...
<tr>
   ...
   <td><input type="text" id="clasificacion" name="clasificacion" size="8" value="<?=$f_clactivo['CodClasificacion'];?>" disabled/>
       <input type="text" id="clasificacion2" name="clasificacion2" size="52" value="<?=$f_clactivo['Descripcion'];?>" disabled/></td>
...
<tr>
   ...
   <td><input type="text" name="ubicacion" id="ubicacion" size="8" value="<?=$f_ubicacion['CodUbicacion'];?>" disabled/>
       <input type="text" name="ubicacion2" id="ubicacion2" size="52" value="<?=$f_ubicacion['Descripcion'];?>" disabled/></td>
...
<tr>
   <td colspan="2"><? if($fa['FlagParaOperaciones']=='S'){ ?>
	                ...
	                <? }else{?>
				      <input type="checkbox" name="disp_operacionesflag" id="disp_operacionesflag" disabled/><? }?> Disponible Para Operaciones</td>
</tr>
<tr>
   ...
   <td colspan="2"><? $s_usuario = "select 
					  ...
					  if($fa['FechaPreparacion']!='0000-00-00'){ list($fano, $fm, $fd)= split('[-]',$fa['FechaPreparacion']); $f_preparado= $fd.'-'.$fm.'-'.$fano;}
					?>
...
<tr><td align="center" colspan="5">Ultima Modif.:<input type="text" name="ultimo_usuario" value="<?=$fa['UltimoUsuario'];?>" size="25" /><input type="text" name="ultima_fecha" value="<?=$ultimaFechaModif;?>" size="20"/></td></tr>
</table>
</div>
<!-- ****************************************************** COMIENZO TAB2 ************************************************ -->
...
?>
  ...
  <td width="199"><input type="hidden" name="fabricante" id="fabricante" size="40" value="<?=$fa['Marca'];?>" disabled/><input type="text" name="fabricante2" id="fabricante2" size="40" value="<?=$fa['Marca'];?>" disabled/></td>
...
<tr>
  ...
  <td colspan="2"><select id="factura" name="factura" style="width:70px;" disabled>
				  ...
				  ?>
                  </select> <? if($fa['FacturaFecha']!='0000-00-00'){list($a, $m, $d) = SPLIT('[-]',$fa['FacturaFecha']); $fechaFactura = $d.'-'.$m.'-'.$a;}?>
...
<tr>
   <td class="tagForm">Orden Compra:</td><? if($fa['NumeroOrdenFecha']!='0000-00-00'){list($a,$m,$d)= SPLIT('[-]',$fa['NumeroOrdenFecha']); $fechaOrdenCompra = $d.'-'.$m.'-'.$a;}?>
   <td><input type="text" id="orden_compra" name="orden_compra" size="25" value="<?=$fa['NumeroOrden']?>" disabled/><input type="text" id="fecha_ordencompra" name="fecha_ordencompra" size="8" value="<?=$fechaOrdenCompra;?>" disabled/></td>
  <td></td>
...
<tr>
   <td class="tagForm">Gu&iacute;a Remisi&oacute;n #:</td><? if($fa['NumeroGuiaFecha']!='0000-00-00'){list($a,$m,$d)= SPLIT('[-]',$fa['NumeroGuiaFecha']); $fechaGuiaRemision = $d.'-'.$m.'-'.$a;}?>
...
<tr>
   <td class="tagForm">Docum. Almacen:</td><? if($fa['DocAlmacenFecha']!='0000-00-00'){list($a,$m,$d)=SPLIT('[-]',$fa['DocAlmacenFecha']);$fechaAlmacen = $d.'-'.$m.'-'.$a;}?>
   ...
   <td></td>
   <td class="tagForm">Monto Referencial:</td><? if($fa['MontoReferencia']!='0000-00-00'){$montoReferencia = number_format($fa['MontoReferencia'],2,',','.');}?>
...
<tr>
   ...
   ?>
   <td><input type="text" name="fecha_inventario" id="fecha_inventario" size="8" value="<?=$fechaInventarioFisico;?>" disabled/></td>
