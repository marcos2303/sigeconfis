...
$texto = ucfirst($texto) ;
	...
	$this->SetXY(10,34);$this->SetFont('Arial', 'B', 8);
						...
						$this->SetFont('Arial', '', 8);$this->Cell(80, 3, utf8_decode($f_cons['Dependencia']), 0, 0, 'L');
						$this->SetFont('Arial', 'B', 8);
						$this->Cell(17, 3, 'SERVICIO:', 0, 0, 'L');
						$this->SetFont('Arial', '', 8);	$this->Cell(80, 3, $cadena, 0, 1, 'L');
	...
	$this->SetXY(10,40);$this->SetFont('Arial', 'B', 8);
						$this->Cell(60, 3, 'PERIODO DE LA CUENTA:', 0, 0, 'L');
						$this->SetFont('Arial', '', 8);$this->Cell(15, 3, '', 0, 1, 'L'); $this->Ln(3);
	...
	/*$this->SetXY(10,22);$this->SetFont('Arial', 'B', 8);
						...
						$this->SetFont('Arial', 'B', 8);
	                    $this->Cell(17, 3, 'SERVICIO:', 0, 0, 'L');
						$this->SetFont('Arial', '', 8);	$this->Cell(20, 3, $cadena, 0, 1, 'L');
...
$sactivo = "select 
			  ...
			  from
				  ...
				  inner join af_tipomovimientos d on (d.CodTipoMovimiento=a.CodTipoMovimiento)
			 where 
...
if($ractivo!=0)
   for($i=0; $i<$ractivo; $i++){
      ...
      if($factivo['TipoMovimiento']=='IN'){
		  $montoIncorporacion = $factivo['MontoLocal'];
		  $montoIncorporacionTotal = $montoIncorporacionTotal + $montoIncorporacion;
	  }else{
		  $montoDesincorporacion = $factivo['MontoLocal'];	  
