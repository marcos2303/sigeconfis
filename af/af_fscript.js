...
function cargarCampoCategoria(valor){ 
 ...
 if(valorEnviado!=""){//alert('');
    var ajax=nuevoAjax();
	ajax.open("POST", "af_fphp_ajax.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"); //alert("accion=cargarCampoCategoria&valorEnviado="+valorEnviado);
...
function c_opcion_estado(form, estadoMovimientoActivo){
 //alert(estadoMovimientoActivo); 
 document.getElementById("estadoMov").value = estadoMovimientoActivo; //alert('Estado= '+document.getElementById("estadoMov").value);
}
//// -------------------------------------------------------------------------------------
//	 -------------------		FUNCION PARA CARGAR UNA NUEVA PAGINA 
...
function guardarNuevoMovimientoActivo(form){
 if(document.getElementById("valorguardar").value==1){ 	
   ...
   var CodTipoMoviDes = document.getElementById("mot_trasl_des").value; //alert('CodTipoMoviDes='+CodTipoMoviDes);
   var CodTipoMoviInc = document.getElementById("mot_trasl_incorp").value; //alert('CodTipoMoviInc='+CodTipoMoviInc);
   ...
   var ajax=nuevoAjax();
	ajax.open("POST", "gmactivofijo.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=guardarNuevoMovimientoActivo&Activo="+Activo+"&Organismo="+Organismo+"&OrganismoAnterior="+OrganismoAnterior+"&OrganismoActual="+OrganismoActual+"&CentroCosto="+CentroCosto+"&CentroCostoAnterior="+CentroCostoAnterior+"&Ubicacion="+Ubicacion+"&UbicacionAnterior="+UbicacionAnterior+"&Dependencia="+Dependencia+"&DependenciaAnterior="+DependenciaAnterior+"&EmpleadoResponsable="+EmpleadoResponsable+"&EmpleadoResponsableAnterior="+EmpleadoResponsableAnterior+"&EmpleadoUsuario="+EmpleadoUsuario+"&EmpleadoUsuarioAnterior="+EmpleadoUsuarioAnterior+"&PreparadoPor="+PreparadoPor+"&InternoExternoFlag="+InternoExternoFlag+"&MotivoTraslado="+MotivoTraslado+"&Comentario="+Comentario+"&CodTipoMoviDes="+CodTipoMoviDes+"&CodTipoMoviInc="+CodTipoMoviInc);
...
function guardarRevisarMovimientoActivo(form){
  ...
  //alert("accion=guardarRevisarMovimientoActivo&Activo="+Activo+"&Organismo="+Organismo+"&NumeroMovimiento="+NumeroMovimiento+"&Estado="+Estado+"&RevisadoPor="+RevisadoPor);
  var ajax=nuevoAjax();
	ajax.open("POST", "gmactivofijo.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=guardarRevisarMovimientoActivo&Activo="+Activo+"&Organismo="+Organismo+"&NumeroMovimiento="+NumeroMovimiento+"&Estado="+Estado+"&RevisadoPor="+RevisadoPor);
...
function AprobarActivo(form){
   ...
   var ajax=nuevoAjax();
	ajax.open("POST", "gmactivofijo.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("accion=AprobarActivo&estado="+estado+"&Activo="+Activo+"&CodOrganismo="+CodOrganismo+"&paso="+paso+"&FechaIngreso="+FechaIngreso+"&FechaInventario="+FechaInventario);
    ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			var resp = ajax.responseText;
			if (resp != ""){ //alert(resp);
			  opener.document.getElementById("frmentrada").submit();
			  window.open('af_actaincorporacion.php?Activo='+Activo+'&CodOrganismo='+CodOrganismo+"&nroActaIncorp="+resp,'', 'height=500, width=870, left=200, top=100, resizable=yes');
	          window.open('af_actaentregabm.php?Activo='+Activo+'&CodOrganismo='+CodOrganismo+"&nroActaEntrega="+resp,'','height=500, width=870, left=200, top=100, resizable=yes');
...
function cargarMotTraslDes(form){
   var mot_trasl_des = document.getElementById("mot_trasl_des").value; //alert('organismoActual='+organismoActual);
...
function cargarMotTraslIncorp(form){
   var mot_trasl_incorp = document.getElementById("mot_trasl_incorp").value; //alert('organismoActual='+organismoActual);
