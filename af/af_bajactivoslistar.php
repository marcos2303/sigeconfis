...
<table width="1000" class="tblLista">
 <tr> <input type="hidden" id="registro" name="registro"/>
  ...
  <td align="right">
    ...
    <input type="button" name="btVer" id="btVer" class="btLista" value="Ver" onclick="cargarOpcion(this.form,'af_bajactivosver.php?accion=VER','BLANK', 'height=600, width=950, left=250, top=50, resizable=no');"/>
    <input type="button" name="btModificar" id="btModificar" class="btLista" value="Modificar" onclick="cargarOpcionListActEditar(this.form, 'af_bajactivosver.php?accion=MODIFICAR&regresar=af_bajactivoslistar','SELF')"/>
