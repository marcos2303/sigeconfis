...
<tr>
   ...
   <tr>
	   ...
	   <td class='gallery clearf'>
		    ...
		    <input type='text' id='centro_costos2' value='$centro_costos2' name='centro_costos2' $dCosto/>";?><input type='hidden' id='btcosto' name='btcosto' value='...' onclick="cargarVentanaLista(this.form,'af_listacentroscostos.php?limit=0&campo=9','height=500,width=800,left=200,top=100,resizable=yes');"  <?=$dCosto?> /> <a id="c_costo" href="../lib/listas/listado_centro_costos.php?filtrar=default&limit=0&campo=1&cod=centro_costos&nom=centro_costos2&ventana=selListadoLista03&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe1]" style="visibility:hidden">
