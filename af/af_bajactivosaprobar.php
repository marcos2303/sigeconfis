...
<table width="1000" class="tblLista">
 <tr> <input type="hidden" id="registro" name="registro"/>
  ...
  <td align="right"></td>
  <td align="right">
    <input type="button" name="btAprobar" id="btAprobar" class="btLista" value="Aprobar" onclick="cargarOpcion(this.form,'af_bajactivosver.php?accion=APROBAR&regresar=af_bajactivoslistar','BLANK', 'height=600, width=950, left=250, top=50, resizable=no')"/>
  </tr>
</table>
...
<thead>
  <tr class="trListaHead">
        ...
        <th width="70" scope="col">Cod.Barras</th>
