...
<tr>
   ...
   <td><input type='checkbox' id='chkfecha' name='chkfecha' value='1' $cFecha onclick='enabledRpAFecha(this.form);'/>
       <input type='text' id='fecha_desde' name='fecha_desde' value='$fecha_desde' size='6' maxlength='10' $dFecha/> al
	   <input type='text' id='fecha_hasta' name='fecha_hasta' value='$fecha_hasta' size='6' maxlength='10' $dFecha/></td>
</tr>
</table>
</div>
