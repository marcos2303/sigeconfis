...
<tr>
   ...
   <tr>
	 ...
	 <td><input type="hidden" id="preparado_por" name="preparado_por" value="<?=$f_con['1'];?>" disabled/><input type='text' id='pre_por' name='pre_por' value="<?=$f_con[0];?>" size='51' disabled/>
	     <input type='text' id='fecha_prepa' name='fecha_prepa' value="<?=date("d-m-Y");?>" size='8' disabled/></td>
	 <td width='5'></td>
...
<tr>
 ...
 <td>Seleccionar <input type="button" id="btactivo" name="btactivo" value="Activo" onclick="cargarVentanaLista(this.form, 'af_selectoractivos.php?limit=0&campo=1&cierre=1','height=520, width=900, left=200, top=70, resizable=yes');"/><input type="button" id="centro_costos" name="centro_costos" value="Centro de Costos" onclick="cargarVentanaLista(this.form, 'af_listacentroscostos.php?limit=0&campo=10','height=500, width=870, left=200, top=100, resizable=yes');"/><input type="button" id="btubicacion" name="btubicacion" value="Ubicaci&oacute;n" onclick="cargarVentanaLista(this.form, 'af_listaubicacionesactivo.php?limit=0&campo=11','height=500, width=870, left=200, top=100, resizable=yes');"/><input type="button" id="btDependencia" name="btDependencia" value="Dependencia" onclick="cargarVentanaLista(this.form, 'af_listadependencias.php?limit=0&campo=14','height=500, width=870, left=200, top=100, resizable=yes');"/> <input type="button" id="btEmpleadoUsuario" name="btEmpleadoUsuario" value="Empl. Usuario" onclick="cargarVentanaLista(this.form, 'af_listaempleados.php?limit=0&campo=12', 'height=500, width=870, left=200, top=100, resizable=yes');"/><input type="button" id="btEmpleadoResponsable" name="btEmpleadoResponsable" value="Empl. Respons." onclick="cargarVentanaLista(this.form, 'af_listaempleados.php?limit=0&campo=13', 'width=870, height=500, top=100, left=200, resizable=yes');"/></td>
 </tr>
</table>
</td>
</tr>
<tr>
  <td align='center'>Ultima Modif.:<input type='text' id='ultimo_usuario' name='ultimo_usuario' size='40' readonly/><input type='text' id='ultima_fecha' name="ultima_fecha" readonly/></td>
</tr>
</table>
...
<tr>
 <td width="98">Centro Costos</td><td colspan="3"><input type="text" id="c_costos" name="c_costos" size="6" disabled/><input type="text" id="c_costos2" name="c_costos2" size="89" disabled/><input type="text" id="c_costosActual" name="c_costosActual" size="6" disabled/><input type="text" id="c_costosActual2" name="c_costosActual2" size="89" disabled/></td>
</tr>
<tr>
 <td>Ubicaci&oacute;n</td><td colspan="3"><input type="text" id="ubicacion" name="ubicacion" size="6" disabled/><input type="text" id="ubicacion2" name="ubicacion2" size="89" disabled/><input type="text" id="ubicacion_Actual" name="ubicacion_Actual" size="6" disabled/><input type="text" id="ubicacion_Actual2" name="ubicacion_Actual2" size="89" disabled/></td>
</tr>
<tr>
 <td>Dependencia</td><td colspan="3"><input type="text" id="dependencia" name="dependencia" size="6" disabled/><input type="text" id="dependencia2" name="dependencia2" size="89" disabled/><input type="text" id="dependenciaActual" name="dependenciaActual" value="" size="6" disabled/><input type="text" id="dependenciaActual2" name="dependenciaActual2" size="89" disabled/></td>
</tr>
<tr>
 <td>Empl. Usuario</td><td colspan="3"><input type="text" id="e_usuario" name="e_usuario" size="6" disabled/><input type="text" id="e_usuario2" name="e_usuario2" size="89" disabled/><input type="text" id="e_usuarioActual" name="e_usuarioActual" size="6" disabled/><input type="text" id="e_usuarioActual2" name="e_usuarioActual2" size="89" disabled/></td>
</tr>
<tr>
 <td>Empl. Respons.</td><td colspan="3"><input type="text" id="e_responsable" name="e_responsable" size="6" disabled/><input type="text" id="e_responsable2" name="e_responsable2" size="89" disabled/><input type="text" id="e_responsableActual" name="e_responsableActual" size="6" disabled/><input type="text" id="e_responsableActual2" name="e_responsableActual2" size="89" disabled/></td>
</tr>
<tr>
 <td>Organismo</td><td colspan="3"><input type="text" id="organismo" name="organismo" size="6" disabled/><input type="text" id="organismo2" name="organismo2" size="89" disabled/><select id="organismoActual" name="organismoActual" onchange="cargarOrganismoMovimiento(this.form);">
                                 <option value=""></option>
	 <?
     ...
     ?>
     </select><input type="text" id="organismoActual2" name="organismoActual2" size="89" disabled/></td>
</tr>
<tr>
