...
var menuItems = [
["Activos", , , , , , "0", , , , , ],
  ["|Activos Menores","<?=$_PARAMETRO['PATHSIA']?>af/af_activosmenores.php?concepto=01-0006&limit=0&filtrar=DEFAULT", , , ,d['01-0006'], , , , , , ], 
  ["|Lista de Activos","<?=$_PARAMETRO['PATHSIA']?>af/af_listactivos.php?concepto=01-0001&limit=0&filtrar=DEFAULT", , , , d['01-0001'], , , , , , ],
  //["|Transacciones","<?=$_PARAMETRO['PATHSIA']?>af/af_transaccioneslista.php?concepto=01-0002&limit=0&filtrar=DEFAULT", , , ,d['01-0002'] , , , , , , ],
  
  ["|Transferir Activos de Logística","<?=$_PARAMETRO['PATHSIA']?>af/af_transferiractivos.php?concepto=01-0005&limit=0&filtrar=DEFAULT", , , ,d['01-0005'] , , , , , , ],
...
["Procesos", , , , , , "0", , , , , ],
 ...
 ["|Baja de Activos", , , , , , , , , , , ],
  ...
  ["||Aprobar Transacción","<?=$_PARAMETRO['PATHSIA']?>af/af_bajactivosaprobar.php?concepto=02-0004&limit=0&filtrar=DEFAULT&regresar=framemain", , , ,d['02-0004'], , , , , , ],
["|Movimientos de Activos", , , , , , , , , , , ],
 ["||Nuevo Movimiento","<?=$_PARAMETRO['PATHSIA']?>af/af_movimientoactivonuevo.php?concepto=02-0005&limit=0&filtrar=DEFAULT&regresar=framemain", , , ,d['02-0005'] , , , , , , ],
 ["||Listar Movimiento","<?=$_PARAMETRO['PATHSIA']?>af/af_movimientoactivos.php?concepto=02-0006&limit=0&filtrar=DEFAULT", , , ,d['02-0006'] , , , , , , ],
 ["||Revisar Movimiento","<?=$_PARAMETRO['PATHSIA']?>af/af_movimientorevisar.php?concepto=02-0007&limit=0&filtrar=DEFAULT", , , ,d['02-0007'] , , , , , , ],
 ["||Aprobar Movimiento","<?=$_PARAMETRO['PATHSIA']?>af/af_aprobarmovimientoactivos.php?concepto=02-0008&limit=0&filtrar=DEFAULT", , , , d['02-0008'], , , , , , ],
...
["Reportes", , , , , , "0", , , , , ],
  ["|Activos", , , , , , , , , , , ],
    ["||Inventario a la Fecha", "<?=$_PARAMETRO['PATHSIA']?>af/af_rpinventarioalafecha.php?concepto=04-0011&limit=0&filtrar=DEFAULT", , , ,d['04-0011'] , , , , , , ],
	["||Inventario X Dependencia", "<?=$_PARAMETRO['PATHSIA']?>af/af_rpinventarioxdependencia.php?concepto=04-0001&limit=0&filtrar=DEFAULT", , , ,d['04-0001'] , , , , , , ],
	["||Inventario Activos Costo", "<?=$_PARAMETRO['PATHSIA']?>af/af_rpinventarioactivoscosto.php?concepto=04-0002&limit=0&filtrar=DEFAULT", , , ,d['04-0002'] , , , , , , ],
	["||Movimiento de Activos", "<?=$_PARAMETRO['PATHSIA']?>af/af_rptabmovimientoactivos.php?concepto=04-0003&limit=0&filtrar=DEFAULT", , , ,d['04-0003'] , , , , , , ],
	["||Ingreso de Activos","<?=$_PARAMETRO['PATHSIA']?>af/af_rptabingresoactivos.php?concepto=04-0004&limit=0&filtrar=DEFAULT", , , d['04-0004'], , , , , , , ],
	["||Catálogo de Activos","<?=$_PARAMETRO['PATHSIA']?>af/af_rptabcatalogoactivos.php?concepto=04-0005&limit=0&filtrar=DEFAULT", , , d['04-0005'], , , , , , , ],
	["||Ingreso y Egreso de Activos","<?=$_PARAMETRO['PATHSIA']?>af/af_rptabingresoegresoactivos.php?concepto=04-0006&limit=0&filtrar=DEFAULT", , , d['04-0006'], , , , , , , ],
	["||Activos x Empleado","<?=$_PARAMETRO['PATHSIA']?>af/af_rptabactivosxempleado.php?concepto=04-0010&limit=0&filtrar=DEFAULT", , , d['04-0010'], , , , , , , ],
	["||Inventario General","<?=$_PARAMETRO['PATHSIA']?>af/af_rpinventariogeneral.php?concepto=04-0011&limit=0&filtrar=DEFAULT", , , d['04-0011'], , , , , , , ],
	["||Inventario General Costo","<?=$_PARAMETRO['PATHSIA']?>af/af_rpinventarioactivoscostogen.php?concepto=04-0012&limit=0&filtrar=DEFAULT", , , d['04-0012'], , , , , , , ],
						
  ["|Clasificaci&oacute;n20", , , , , , , , , , , ],
	["||Formulario BM-1", "<?=$_PARAMETRO['PATHSIA']?>af/af_rpformulariobm_1.php?concepto=04-0007&limit=0$filtrar=DEFAULT", , , ,d['04-0007'] , , , , , , ],	
	["||Formulario BM-2", "<?=$_PARAMETRO['PATHSIA']?>af/af_rpformulariobm_2.php?concepto=04-0008&limit=0$filtrar=DEFAULT", , , ,d['04-0008']  , , , , , , ],	
	["||Formulario BM-3", "<?=$_PARAMETRO['PATHSIA']?>af/af_rpformulariobm_3.php?concepto=04-0009&limit=0$filtrar=DEFAULT", , , , d['04-0009'] , , , , , , ],	
...
["|Generación de Voucher", , , , , , , , , , , ],
  ["||Publicación 20", , , , , , , , , , , ],
    ["|||Nuevo", "<?=$_PARAMETRO["PATHSIA"]?>af/af_genvouchernuevoactivo.php?limit=0&concepto=07-0007", , , , , , , , , ,],
	["|||Transacción de Baja","<?=$_PARAMETRO["PATHSIA"]?>af/af_genvouchertransaccionactivo.php?cont=F&limit=0&concepto=07-0008", , , , , , , , , , ],
  ["||Contabilidad Onco", , , , , , , , , , , ],
    ["|||Nuevo", "<?=$_PARAMETRO["PATHSIA"]?>af/af_genvouchernuevoactivo.php?limit=0&concepto=07-0009", , , , , , , , , ,],
	["|||Transacción de Baja","<?=$_PARAMETRO["PATHSIA"]?>af/af_genvouchertransaccionactivo.php?cont=T&limit=0&concepto=07-0010", , , , , , , , , , ],
