...
if($accion=="ver"){
  $bt_aprobar= "hidden";
  $bt_cerrar= "hidden";
  $titulo = "Lista Activos";
  $titulo2 = "Ver";
  
}else
if($accion=="aprobar" or $hacer=="aprobar"){
  $bt_aprobar="visibility";
  $bt_cerrar="visibility";
  $titulo = "Aprobar";
  $titulo2 = "Activo Mayor";
}
...
<tr>
  ...
  <td class="tagForm">Categor&iacute;a:</td>
   <td width="303"><?
				   ...
				   ?>
                   <select id="select_categoria" style=" width:65px" onchange="cargarCampoCategoria(this.id)" disabled>
                     <option value="<?=$CodCategoria;?>"><?=$CodCategoria;?></option>
                     </select>
                   <input type="text" id="categoria" name="categoria" size="50" value="<?=$DescripcionLocal;?>" disabled/></td>
   <td width="42"></td> 
</tr>
<tr>
  ...
  ?>
   ...
   ?>
   <td><input type="hidden" id="clasificacion20" name="clasificacion20" value="<?=$f_c20['CodClasificacion'];?>" disabled/><input type="text" id="clasificacion20Descp" name="clasificacion20Descp" size="67" value="<?=$f_c20['Descripcion'];?>" disabled/></td>
   <td class="gallery clearfix"><input type="hidden" name="btClasificacion20" id="btClasificacio20" value="..." onclick="cargarVentanaLista(this.form, 'af_listaclasificacionPub20.php?limit=0&campo=1&ventana=insertarClasificacionPub20','height=500, width=800, left=200, top=100, resizable=yes');" disabled/> </td>
</tr>
<tr>
...
<tr>
   ...
   ?>
   <td><input type="hidden" name="cod_usuario" id="cod_usuario" value="" /><input type="text" id="nomb_usuario" name="nomb_usuario" size="67" value="<?=$f_empusuario['NomCompleto'];?>" disabled/></td>
...
<tr>
   ...
   ?>
   <td><input type="hidden" id="cod_empresponsable" name="cod_empresponsable" value="" disabled="true"/><input type="text" id="empleado_responsable" name="empleado_responsable" size="67" value="<?=$f_empresp['NomCompleto'];?>" disabled/></td>
...
<tr>
   ...
   <?
    ...
    <input type="checkbox" name="disp_mantenimientoflag" id="disp_mantenimientoflag"  checked="checked" onclick='this.checked=true;'/>
    <? }else{ ?>
     <input type="checkbox" name="disp_mantenimientoflag" id="disp_mantenimientoflag"  disabled/>
...
<tr>
   ...
   <?
    ...
    <input type="checkbox" name="disp_operacionesflag" id="disp_operacionesflag" checked="checked" onclick='this.checked=true;'/>
    <? }else{?>
    <input type="checkbox" name="disp_operacionesflag" id="disp_operacionesflag" disabled/> 
...
<tr>
  ...
  <td colspan="2" align="left"><? if($fa['DepreEspecificaFlag']=='S'){?><input type="checkbox" name="depre_especifica" id="depre_especifica" checked onclick='this.checked=true;'/><? }else{?><input type="checkbox" name="depre_especifica" id="depre_especifica" disabled/><? }?> Depreciaci&oacute;n Espec&iacute;fica</td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="2"><? if($fa['GenerarVoucherIngresoFlag']=='S'){?><input type="checkbox" name="gen_voucher" id="gen_voucher" checked="checked" onclick='this.checked=true;'/><? }else{?><input type="checkbox" name="gen_voucher" id="gen_voucher" disabled/><? }?>Generar Voucher de Ingreso del Activo</td>
</tr>
<tr>
 <td height="5"></td>
</tr>
...
<tr>
  <td class="tagForm">Proveedor:</td>
	 ...
	 ?>
  <td colspan="2"><input type="text" id="proveedor" name="proveedor" size="8" value="<?=$f_proveedor['codProveedor'];?>" disabled/> <input type="text" id="nomb_proveedor" name="nomb_proveedor" size="48" value="<?=$f_proveedor['NombProveedor'];?>" disabled/>
...
<tr>
   ...
   <td><input type="text" id="orden_compra" name="orden_compra" size="25" value="<?=$fa['NumeroOrden']?>" style="text-align:right;" disabled/><input type="text" id="fecha_ordencompra" name="fecha_ordencompra" size="8" value="<?=$fechaOrdenCompra;?>" disabled/></td>
  <td></td>
...
<tr>
   ...
   <td><input type="text" id="nro_guiaremision" name="nro_guiaremision" size="25" value="<?=$fa['NumeroGuia'];?>" style="text-align:right;" disabled/><input type="text" id="fecha_guiaremision" name="fecha_guiaremision" size="8" value="<?=$fechaGuiaRemision;?>" disabled/></td>
   <td></td>
...
<tr>
   ...
   <td><input type="text" name="fecha_inventario" id="fecha_inventario" size="8" value="<?=$fecha_ingreso;?>"/></td>
   <td class="tagForm">Observaciones</td>
   <td colspan="3"><textarea name="observacion" id="observacion" rows="2" cols="80" disabled="disabled"><?=$fa['DescpCorta'];?></textarea></td>
</tr>
</table>
</div>
<!-- ****************************************************** COMIENZO TAB3 ************************************************ -->
...
<tr>
  ...
  <td colspan="3"><select id="tipobaja" name="tipobaja" class="selectSma" disabled="disabled">
                  <option></option>
     <?
...
<center><input type="submit" name="btAprobar" id="btAprobar" value="Aprobar"  style="visibility:<?=$bt_aprobar;?>"/><input type="button" name="btCancelar" id="btCancelar" value="Cancelar" onclick="window.close();"  style="visibility:<?=$bt_cerrar;?>"/></center>
</form>
