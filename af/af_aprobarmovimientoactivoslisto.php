...
<?
  $s_consulta = "select 
				  ...
				  where
					   ...
					   afm.Organismo = '$organismo'"; //echo $s_consulta;
  $q_consulta = mysql_query($s_consulta) or die ($s_consulta.mysql_error());
  $f_consulta = mysql_fetch_array($q_consulta);
?>
<td colspan="4"><input type="text" name="nro_movimientos" id="nro_movimientos" style="border-color:#666; text-align:right" size="18" value="1" disabled/><input type="text" id="activo" name="activo" style="border-color:#666; text-align:right" size="60" value='<?=$f_consulta['Activo'];?>' disabled/><input type="text" id="descripcion" name="descripcion" style="border-color:#666" size="88" value="<?=$f_consulta['Descripcion'];?>" disabled/> Cod.Bar. <input type="text" id="cod_bar" name="cod_bar" size="37" style="border-color:#666; text-align:right" disabled value="<?=$f_consulta['CodigoBarras'];?>"/></td>
</tr>
<tr>
 <td width="98">Centro Costos</td><td colspan="3"><input type="text" id="c_costos" name="c_costos" size="6" value="<?=$f_consulta['cc_Anterior'];?>" disabled/><input type="text" id="c_costos2" name="c_costos2" size="89" value="<?=htmlentities($f_consulta['Descpcc_Anterior']);?>" disabled/><input type="text" id="c_costosActual" name="c_costosActual" size="6" value="<?=$f_consulta['cc_Actual'];?>" disabled/><input type="text" id="c_costosActual2" name="c_costosActual2" size="89" value="<?=htmlentities($f_consulta['Descpcc_Actual']);?>" disabled/></td>
</tr>
<tr>
 <td>Ubicaci&oacute;n</td><td colspan="3"><input type="text" id="ubicacion" name="ubicacion" size="6" value="<?=$f_consulta['ub_Anterior'];?>" disabled/><input type="text" id="ubicacion2" name="ubicacion2" size="89" value="<?=htmlentities($f_consulta['Descpubi_Anterior']);?>" disabled/><input type="text" id="ubicacion_Actual" name="ubicacion_Actual" size="6" value="<?=$f_consulta['ub_Actual'];?>" disabled/><input type="text" id="ubicacion_Actual2" name="ubicacion_Actual2" size="89" value="<?=htmlentities($f_consulta['Descpubi_Actual']);?>" disabled/></td>
</tr>
<tr>
...
<center>
 <input type="submit" id="guardar" name="guardar" value="Aprobar"/>
