...
<table width="1143" class="tblLista">
 ...
 <input type="button" name="btImprimir" id="btImprimir" class="btLista" value="Imprimir" onclick="cargarImprimir(this.form,'af_rptransferenciaactivofijo.php?fmovimiento=<?=$fmovimiento;?>&fEstado=<?=$fEstado;?>&origen=lista','BLANK', 'height=550, width=1100, left=150, top=50, resizable=no');"/>
...
<thead>
  ...
  if($ra!=0){
   ...
   for($i=0;$i<$ra;$i++){
     ...
     $id= $fa['Organismo']."|".$fa['MovimientoNumero']."|".$fa['Estado'];
	 //// ----------------------------------------------------------------
	 ...
	 //// ----------------------------------------------------------------
     $cont++;
    echo"<tr class='trListaBody' onclick='mClk(this, \"registro\")|c_opcion_estado(this, \"$estadoMovimiento\");' id='$id'>	
...
<thead>
  <tr class="trListaHead">
		...
		<th width="40" scope="col">C. Costo Actual</th>
        <th width="100" scope="col">Descripcion</th>
        <th width="40" scope="col">C.Costo Anterior</th>
        <th width="100" scope="col">Descripci&oacute;n</th>
        <th width="100" scope="col">Ubicaci&oacute;n Actual</th>
  </tr>
  </thead>
  <?
