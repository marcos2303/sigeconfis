...
<table width="1000" class="tblLista">
 <tr> <input type="hidden" id="registro" name="registro"/>
  ...
  <td align="right">
  <input type="button" id="btRevisar" name="btRevisar" class="btLista" value="Revisar" onclick="cargarOpcion(this.form,'af_bajactivosver.php?accion=REVISAR&regresar=af_bajactivoslistar','BLANK', 'height=600, width=950, left=250, top=50, resizable=no')"/>
