...
<table width="1050" class="tblBotones">
	<tr>
		...
		<td align="right">
			...
			<input type="button" id="btImprimir" value="Imprimir" style="width:75px; <?=$btImprimir?>" onclick="cargarOpcion2(this.form, '<?=$pdf?>.php?', 'BLANK', 'height=800, width=750, left=200, top=200, resizable=no', $('#registro').val());" /> | 
