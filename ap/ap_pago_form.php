...
<input type="hidden" id="Periodo" value="<?=$field['Periodo']?>" />
<input type="hidden" id="CodVoucher" value="<?=substr($field['VoucherPago'], 0, 2)?>" />
<input type="hidden" id="CodVoucherPub20" value="<?=substr($field['VoucherPagoPub20'], 0, 2)?>" />
...
<table align="center" width="1000" class="tblForm">
    ...
    <tr>
        ...
        <td>
        	...
        	<input type="hidden" id="FlagContPendientePub20" value="<?=$field['FlagContPendientePub20']?>" />
        </td>
    </tr>
    <tr>
        ...
        <td>
            <input type="text" id="VoucherPeriodo" style="width:40px;" value="<?=$field['VoucherPeriodo']?>" disabled="disabled" />-
            <input type="text" id="VoucherPago" style="width:40px;" value="<?=$field['VoucherPago']?>" disabled="disabled" />
            &nbsp;
            <input type="text" id="PeriodoPagoPub20" style="width:40px;" value="<?=$field['PeriodoPagoPub20']?>" disabled="disabled" />-
            <input type="text" id="VoucherPagoPub20" style="width:40px;" value="<?=$field['VoucherPagoPub20']?>" disabled="disabled" />
        </td>
    </tr>
    <tr>
