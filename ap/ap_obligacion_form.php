...
if ($opcion == "nuevo") {
	...
	$Anio = "$AnioActual";
	//	presupuesto
	$sql = "SELECT CodPresupuesto FROM pv_presupuesto WHERE EjercicioPpto = '".$Anio."' AND Organismo = '".$field_obligacion['CodOrganismo']."'";
	...
	<tr>
    	<td valign="top" colspan="2">
            ...
            <table width="1100" class="tblBotones">
                <tr>
                    <td class="gallery clearfix">
                        <a id="aSelPartida" href="../lib/listas/listado_clasificador_presupuestario_disponible.php?ventana=iframe=true&width=900&height=500" rel="prettyPhoto[iframe5]" style="display:none;"></a>
                        <a id="aSelCuenta" href="../lib/listas/listado_plan_cuentas.php?filtrar=default&cod=CodCuenta&nom=NomCuenta&ventana=selListadoLista&seldetalle=sel_distribucion&iframe=true&width=915&height=515" rel="prettyPhoto[iframe6]" style="display:none;"></a>
                        <a id="aSelCuenta20" href="../lib/listas/listado_plan_cuentas_pub20.php?filtrar=default&cod=CodCuentaPub20&nom=NomCuentaPub20&ventana=selListadoLista&seldetalle=sel_distribucion&iframe=true&width=915&height=515" rel="prettyPhoto[iframe7]" style="display:none;"></a>
                        <a id="aSelCCosto" href="../lib/listas/listado_centro_costos.php?filtrar=default&cod=CodCentroCosto&nom=CodCentroCosto&ventana=selListadoLista&seldetalle=sel_distribucion&iframe=true&width=1050&height=500" rel="prettyPhoto[iframe8]" style="display:none;"></a>
                        <a id="aSelPersona" href="../lib/listas/listado_personas.php?filtrar=default&cod=CodPersona&nom=NomPersona&ventana=selListadoLista&seldetalle=sel_distribucion&iframe=true&width=1050&height=500" rel="prettyPhoto[iframe9]" style="display:none;"></a>
            ...
            <table width="2200" class="tblLista" id="tabla_distribucion">
                ...
                <tr>
                    <th scope="col" width="15">#</th>
                    <th scope="col" align="left" colspan="2">Partida</th>
                    <th scope="col" align="left" colspan="2">Cta. Contable</th>
                    <th scope="col" align="left" colspan="2">Cta. Contable (Pub. 20)</th>
                    <th scope="col" width="40">C.C.</th>
                    <th scope="col" width="35">No Afe.</th>
                    <th scope="col" width="100">Monto</th>
                    <th scope="col" colspan="2">Nro. Documento</th>
...
<table width="100%" class="tblLista">
	...
	while ($field_partidas = mysql_fetch_array($query_partidas)) {
		$nropartidas++;
		list($MontoAjustado, $MontoCompromiso, $MontoPendiente) = disponibilidadPartida($Anio, $field_obligacion['CodOrganismo'], $field_partidas['cod_partida'], $field_obligacion['CodPresupuesto']);
		if ($field_obligacion['FlagCompromiso'] == "S") $MontoDisponible = $MontoAjustado - $MontoCompromiso;
		else $MontoDisponible = $MontoAjustado - $MontoCompromiso + $field_partidas['Monto'];
