...
<table width="600" class="tblForm">
	...
	<tr>
		...
		<td>
            <input type="text" id="Descripcion" style="width:90%;" maxlength="25" value="<?=htmlentities($field['Descripcion'])?>" <?=$disabled_ver?> />
		</td>
    </tr>
    <tr>
	...
	<tr>
		...
		<td class="gallery clearfix">
            ...
            <a href="../lib/listas/listado_clasificador_presupuestario.php?filtrar=default&cod=cod_partida&iframe=true&width=950&height=525" rel="prettyPhoto[iframe1]" style=" <?=$display_ver?>">
