...
//	presupuesto
$sql = "SELECT CodPresupuesto FROM pv_presupuesto WHERE EjercicioPpto = '".$_Anio."' AND Organismo = '".$field_obligacion['CodOrganismo']."'";
    ...
    <tr>
		...
		<td>
        	<select id="NroCuenta" style="width:200px;">
                <?=loadSelect("ap_ctabancaria", "NroCuenta", "NroCuenta", $field_obligacion['NroCuenta'], 1)?>
            </select>
        </td>
