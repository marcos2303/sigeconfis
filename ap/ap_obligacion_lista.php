...
<?php
//$mostrar = "vouchers";
//$registro = "0001.000115.FP.0606969.01";
//$registro = "0001.000163.NO.000120130102FIN01.01";
//$accion = "ap_generar_vouchers_provision_voucher_pub20";
//$accion = "ap_generar_vouchers_obligacion";
//	muestro vouchers
if ($mostrar == "vouchers") {
	?>
...
elseif ($mostrar == "vouchers-anulacion") {
    ...
    <script type="text/javascript">
	$(document).ready(function() {
		var url = "gehen.php?anz=<?=$accion?>&registro=<?=$registro?>&accion=ver&origen=obligacion-anulacion&iframe=true&width=1050&height=575";
