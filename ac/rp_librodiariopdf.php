...
function Header(){
	...
	$this->Cell(35, 3, 'NRO. DOC.', 0, 0, 'C');
	$this->Cell(13, 3, 'DEBE', 0, 0, 'R');
  ...
  for($i=0; $i<$r_con01; $i++){ //echo $i.'/';
	 ...
	 if($f_con01['Voucher'] != $codVoucherCapturada){
		if($cont==1){
	       ...
	       $pdf->Cell(104,6, '',0,0,'L'); $pdf->Cell(48,6,'TOTAL VOUCHER ->',0,0,'R'); $pdf->Cell(22,6,$t_debe,0,0,'C');
		   $pdf->Cell(18,6,$t_haber,0,1,'C');
		   $t_debe=''; $t_haber='';
		}
	...
	$_i = $contMax+1; 
	  ...
	  $pdf->Row(array($f_con01['Linea'],$f_con01['CodCuenta'],$f_con01['Descripcion'],$f_con01['CodCentroCosto'],$f_con01['ReferenciaTipoDocumento'].'-'.$f_con01['ReferenciaNroDocumento'], $debe01, $haber01));
