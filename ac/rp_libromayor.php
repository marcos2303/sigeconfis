...
<tr>
  <td align='right'>Titulo Libro:</td>
  <td>
	<input type='checkbox' name='chkLibro' id='chkLibro' value='1' $cLibro onclick='this.checked=true'/>
	<input type='text' name='fLibro' id='fLibro' $dLibro value='MAYOR' readonly/> 
</td>
  <td align='right'>Seleccionar Cuenta:</td>
  <td><input type='checkbox' id='chkCuenta' name='chkCuenta' value='1' $cCuenta onclick='enabledRPCuenta(this.form);'/>
      <input type='text' id='fCuentaDesde' name='fCuentaDesde' size='15' maxlength='10' value='$fCuentaDesde' $dCuenta/>
	  <input type='text' id='fCuentaHasta' name='fCuentaHasta' size='15' maxlength='10' value='$fCuentaHasta' $dCuenta/></td>
</tr>
