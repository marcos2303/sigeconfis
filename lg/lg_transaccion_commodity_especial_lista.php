...
<table width="1050" class="tblBotones">
	<tr>
		<td align="right" class="gallery clearfix">
            ...
            <input type="button" id="btCerrar" value="Cerrar" style="width:75px;" onclick="opcionRegistroMultipleCajaChica(this.form, 'cerrar-detalle-compras');" />
		</td>
	</tr>
</table>
<div style="overflow:scroll; width:1050px; height:200px;">
...
<table width="1050" class="tblBotones">
	<tr>
		<td align="right">
			<input type="button" id="btDespachar" value="Despachar" style="width:75px;" onclick="cargarOpcionDespachoCommodity(this.form);" /> | 			<input type="button" id="btCerrar" value="Cerrar" style="width:75px;" onclick="opcionRegistroMultipleCajaChica(this.form, 'cerrar-detalle-requerimiento');" />
		</td>
	</tr>
</table>
<div style="overflow:scroll; width:1050px; height:200px;">
