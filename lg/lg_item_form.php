...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td colspan="3"><input type="text" id="CodBarra" style="width:200px;" maxlength="25" value="<?=$field_item['CodBarra']?>" /></td>
	</tr>
	<tr>
		<td class="tagForm">Stock Minimo:</td>
		<td colspan="3"><input type="text" id="StockMin" style="width:100px; text-align:right;" value="<?=$field_item['StockMin']?>" /></td>
	</tr>
	<tr>
		<td class="tagForm">Stock Máximo:</td>
		<td colspan="3"><input type="text" id="StockMax" style="width:100px; text-align:right;" value="<?=$field_item['StockMax']?>" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="gallery clearfix">
        	<input type="text" id="CtaInventarioPub20" disabled="disabled" style="width:100px;" value="<?=$field_item['CtaInventarioPub20']?>" />
			<input type="hidden" id="NomCtaInventarioPub20" />
			<a href="../lib/listas/listado_plan_cuentas_pub20.php?filtrar=default&cod=CtaInventarioPub20&nom=NomCtaInventarioPub20&iframe=true&width=950&height=525" rel="prettyPhoto[iframe6]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;" />
            </a>
		</td>
	</tr>
	<tr>
		...
		<td class="gallery clearfix">
        	<input type="text" id="CtaGastoPub20" disabled="disabled" style="width:100px;" value="<?=$field_item['CtaGastoPub20']?>" />
			<input type="hidden" id="NomCtaGastoPub20" />
			<a href="../lib/listas/listado_plan_cuentas_pub20.php?filtrar=default&cod=CtaGastoPub20&nom=NomCtaGastoPub20&iframe=true&width=950&height=525" rel="prettyPhoto[iframe7]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;" />
            </a>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="gallery clearfix" colspan="3">
			...
			<a href="../lib/listas/listado_clasificador_presupuestario.php?filtrar=default&ventana=item&iframe=true&width=950&height=525" rel="prettyPhoto[iframe5]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;" />
            </a>
        </td>
	</tr>
