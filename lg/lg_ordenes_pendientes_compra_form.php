...
<table width="2500" class="tblLista">
	...
	while ($field_detalles = mysql_fetch_array($query_detalles)) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>">
			...
			<td align="center">
            	<input type="text" name="CantidadPedida" class="cell2" style="text-align:right;" value="<?=number_format($field_detalles['CantidadCompra'], 2, ',', '.')?>" onBlur="numeroBlur(this);" onFocus="numeroFocus(this);" onchange="setMontosOrdenCompra(this.form);" readonly />
            </td>
			<td align="center">
