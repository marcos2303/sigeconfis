...
<table width="1050" class="tblBotones">
	<tr>
		<td align="right">
            ...
            <input type="button" id="btCerrar" value="Cerrar" style="width:75px;" onclick="opcionRegistroMultiple(this.form, 'Secuencia', 'almacen', 'cerrar-detalle-requerimiento', true);" />
		</td>
	</tr>
</table>
<div style="overflow:scroll; width:1050px; height:200px;">
