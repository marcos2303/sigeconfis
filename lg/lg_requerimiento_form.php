...
elseif ($opcion == "modificar" || $opcion == "ver" || $opcion == "revisar" || $opcion == "conformar" || $opcion == "aprobar" || $opcion == "anular" || $opcion == "cerrar") {
	...
	if ($field_requerimiento['VerCajaChica'] == "S" && $opcion == "conformar") $disabled_cajachica = ""; else $disabled_cajachica = "disabled";
