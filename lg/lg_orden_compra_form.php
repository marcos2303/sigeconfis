...
<table width="1100" class="tblForm">
    ...
    <tr>
		...
		<td class="gallery clearfix">
            ...
            <a href="../lib/listas/listado_personas.php?filtrar=default&cod=CodProveedor&nom=NomProveedor&EsProveedor=S&ventana=selListadoOrdenCompraPersona&iframe=true&width=950&height=445" rel="prettyPhoto[iframe1]" id="btProveedor" style=" <?=$display_modificar?>">
    ...
    <tr>
		...
		<td>
        	<input type="text" id="NomContacto" value="<?=htmlentities($field_orden['NomContacto'])?>" maxlength="50" style="width:300px;" <?=$disabled_ver?> />
        </td>
    ...
    <tr>
		...
		<td>
        	<input type="text" id="Entregaren" value="<?=htmlentities($field_orden['Entregaren'])?>" maxlength="75" style="width:300px;" <?=$disabled_ver?> />
        </td>
    ...
    <tr>
		...
		<td>
        	<input type="text" id="DirEntrega" value="<?=htmlentities($field_orden['DirEntrega'])?>" maxlength="75" style="width:300px;" <?=$disabled_ver?> />
        </td>
    ...
    <tr>
		...
		<td>
        	<input type="text" id="InsEntrega" value="<?=htmlentities($field_orden['InsEntrega'])?>" maxlength="75" style="width:300px;" <?=$disabled_ver?> />
        </td>
	...
	<tr>
		...
		<td colspan="3"><textarea id="Observaciones" style="width:95%; height:30px;" <?=$disabled_ver?>><?=htmlentities($field_orden['Observaciones'])?></textarea></td>
	</tr>
	<tr>
		<td class="tagForm">Descripci&oacute;n Detallada:</td>
		<td colspan="3"><textarea id="ObsDetallada" style="width:95%; height:50px;" <?=$disabled_ver?>><?=htmlentities($field_orden['ObsDetallada'])?></textarea></td>
	</tr>
	<tr>
...
<table width="2500" class="tblLista">
	...
	<tr>
        ...
        <th scope="col" width="45">Uni. (Rec.)</th>
