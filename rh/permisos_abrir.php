...
$pdf->SetXY(11, $y+7); $pdf->SetFont('Arial', '', 9); $pdf->MultiCell(98, 4, utf8_decode($field['NomAprobador']), 0, 'L');
$pdf->SetXY(111, $y+7); $pdf->SetFont('Arial', '', 9); $pdf->MultiCell(93, 5, utf8_decode($field['CargoAprobador']), 0, 'L');
$y=174;
$pdf->Rect(10, $y, 100, $h1); $pdf->Rect(110, $y, 95, $h1);
...
$pdf->SetXY(111, $y); $pdf->SetFont('Arial', 'B', 9); $pdf->Cell(93, 5, 'CARGO:', 0, 1, 'L');
$pdf->Rect(10, $y+5, 100, $h3); $pdf->Rect(110, $y+5, 95, $h3);
list($nombrerh, $cargorh) = getFirmaPermisos();
$pdf->SetXY(11, $y+7); $pdf->SetFont('Arial', '', 9); $pdf->MultiCell(98, 4, $nombrerh, 0, 'L');
$pdf->SetXY(111, $y+7); $pdf->SetFont('Arial', '', 9); $pdf->MultiCell(93, 5, $cargorh, 0, 'L');
$y=226;
$pdf->Rect(10, $y, 100, $h1); $pdf->Rect(110, $y, 95, $h1);
$pdf->SetXY(11, $y); $pdf->SetFont('Arial', 'B', 9); $pdf->Cell(98, 5, 'FIRMA Y SELLO:', 0, 1, 'C');
$pdf->SetXY(111, $y); $pdf->SetFont('Arial', 'B', 9); $pdf->Cell(93, 5, 'FECHA:', 0, 1, 'C');
