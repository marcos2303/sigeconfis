...
<table width="1000" class="tblFiltro">
	...
	<tr>
		...
		<td>
			<input type="checkbox" checked onclick="this.checked=!this.checked;" />
			<select name="fCodTipoNom" id="fCodTipoNom" style="width:300px;" onChange="getOptionsSelectMultiple($('#fPeriodo'), 'periodo-bono', 'CodOrganismo='+$('#fCodOrganismo').val()+'&CodTipoNom='+$('#fCodTipoNom').val(), true); getOptionsSelectMultiple($('#fSemana'), 'semana-bono', 'Periodo='+$('#fPeriodo').val(), true);">
	...
	<tr>
		...
		<td>
			<input type="checkbox" checked onclick="this.checked=!this.checked;" />
			<select name="fPeriodo" id="fPeriodo" style="width:65px;" onChange="getOptionsSelectMultiple($('#fSemana'), 'semana-bono', 'Periodo='+$('#fPeriodo').val(), true);">
            	<option value="">&nbsp;</option>
