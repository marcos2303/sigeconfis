	...
	if ($registros!=0) {
		...
		for ($i=0; $i<$rows; $i++) {
			...
			<tr class='trListaBody' onclick='mClk(this, \"registro\");' onmouseover='mOvr(this);' onmouseout='mOut(this);' id='".$field['CodPermiso']."'>
				...
				<td align='center'>".$field['DescFalta']."</td>
