...
function Cabecera($pdf) {
	...
	$pdf->SetXY(20, 10); $pdf->Cell(270, 5,utf8_decode( 'Contraloría del Estado Delta Amacuro'), 0, 1, 'L');
	$pdf->SetXY(20, 15); $pdf->Cell(270, 5, utf8_decode('Dirección de Recursos Humanos'), 0, 1, 'L');	
