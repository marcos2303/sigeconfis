...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td align="right"><a class="cerrar" href="javascript:" onClick="cargarPagina(document.getElementById('frmentrada'), '<?=$regresar?>.php?limit=<?=$limit?>&filtro=<?=$_POST["filtro"]?>');">[cerrar]</a></td>
	</tr>
...
<table width="700" class="tblForm">
  ...
  <tr>
    ...
    <td>
		<input name="fdesde" type="text" id="fdesde" size="15" maxlength="10" value="<?=$fecha?>" onchange="getTotalDiasPermisos();" /> - 
		<input name="fhasta" type="text" id="fhasta" size="15" maxlength="10" value="<?=$fecha?>" onchange="getTotalDiasPermisos();" /> * 
  ...
  <tr>
    ...
    <td>
		<input name="hdesde" type="text" id="hdesde" size="3" maxlength="5" value="<?=$hora?>" onchange="getTotalDiasPermisos();" />
		<select name="turnodesde" id="turnodesde" onchange="getTotalDiasPermisos();">
			<?php getMeridian($meridiano, 0); ?>
		</select> - 
		<input name="hhasta" type="text" id="hhasta" size="3" maxlength="5" value="<?=$hora?>" onchange="getTotalDiasPermisos();" />
...
<input name="bt_cancelar" type="button" id="bt_cancelar" value="Cancelar" onClick="cargarPagina(this.form, '<?=$regresar?>.php?limit=<?=$limit?>&filtro=<?=$_POST["filtro"]?>');" />
</center><br />
<?php
//	FILTRO..............
echo "
