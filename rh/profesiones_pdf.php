...
function Cabecera($pdf) {
	...
	$pdf->Cell(190, 10, 'Maestro de Profesiones', 0, 1, 'C');	
	$pdf->SetDrawColor(0, 0, 0); $pdf->SetFillColor(200, 200, 200); $pdf->SetTextColor(0, 0, 0);
	$pdf->SetFont('Arial', 'B', 6);
	$pdf->Cell(30, 5, 'PROFESION', 1, 0, 'C', 1);
...
Cabecera($pdf);
//	Cuerpo
$query=mysql_query("SELECT CodProfesion, Descripcion, Estado FROM rh_profesiones ORDER BY Descripcion, CodProfesion") or die ($sql.mysql_error());
