        ...
        <td width="60%" valign="top">
            ...
            <table width="100%" class="tblFiltro">
                ...
                <tr>
                    ...
                    <td align="right">
                        <input type="text" style="width:50px; text-align:right;" class="codigo" value="<?=$field_dias['DiasPago']?>" disabled />
                    </td>
                    <td align="right">
                        <input type="text" style="width:50px; text-align:right;" class="codigo" value="<?=$Trabajados?>" disabled />
                    </td>
                    <td align="right">
