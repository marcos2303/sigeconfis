			...
			var menuItems = [
				["Gesti&oacute;n", , , , , , "0", , , , , ],
					...
					["|Relaciones Laborales", , , , , , , , , , , ],
						["||Control de Contratos", "<?=$_PARAMETRO["PATHSIA"]?>rh/contratos.php?concepto=01-0002&_APLICACION="+_A, , , , d['01-0002'], , , , , , ],
					...
					["|Capacitaci&oacute;n", , , , , , , , , , , ],
						...
						["||Nueva Capacitaci&oacute;n", "<?=$_PARAMETRO["PATHSIA"]?>rh/capacitacion_nueva.php?tab1=1&tab2=1&tab3=1&tab4=0&tab5=0&tab6=0&tab7=0&regresar=framemain&concepto=01-0010&_APLICACION="+_A, , , , d['01-0010'], , , , , , ],
						
						["||Lista de Capacitaciones", "<?=$_PARAMETRO["PATHSIA"]?>rh/capacitacion_lista.php?limit=0&filtrar=DEFAULT&concepto=01-0011&_APLICACION="+_A, , , , d['01-0011'], , , , , , ],	
						
						["||Aprobar Capacitaciones", "<?=$_PARAMETRO["PATHSIA"]?>rh/capacitacion_aprobar.php?limit=0&filtrar=DEFAULT&concepto=01-0012&_APLICACION="+_A, , , , d['01-0012'], , , , , , ],	
						
						["||Iniciar/Terminar Capacitaciones", "<?=$_PARAMETRO["PATHSIA"]?>rh/capacitacion_iniciar.php?limit=0&filtrar=DEFAULT&concepto=01-0013&_APLICACION="+_A, , , , d['01-0013'], , , , , , ],
					...
					["|Permisos", , , , , , , , , , , ],
						["||Crear Permisos", "<?=$_PARAMETRO["PATHSIA"]?>rh/permisos_nuevo.php?limit=0&regresar=framemain&concepto=01-0016&_APLICACION="+_A, , , , d['01-0016'], , , , , , ],
						["||Listar Permisos", "<?=$_PARAMETRO["PATHSIA"]?>rh/permisos.php?limit=0&filtrar=DEFAULT&concepto=01-0017&_APLICACION="+_A, , , , d['01-0017'], , , , , , ],
						["||Aprobar Permisos", "<?=$_PARAMETRO["PATHSIA"]?>rh/permisos_lista.php?limit=0&filtrar=DEFAULT&concepto=01-0018&_APLICACION="+_A, , , , d['01-0018'], , , , , , ],
					...
					["|Vacaciones", , , , , , , , , , , ],
						...
						["||Conformar Solicitud", "<?=$_PARAMETRO["PATHSIA"]?>rh/gehen.php?anz=rh_vacaciones_lista&lista=aprobar&filtrar=default&concepto=01-0027&_APLICACION="+_A, , , , d['01-0027'], , , , , , ],
					...
					["|Retenciones Judiciales", , , , , , , , , , , ],
						["||Lista de Retenciones", "<?=$_PARAMETRO["PATHSIA"]?>rh/rjudiciales.php?limit=0&filtrar=DEFAULT&concepto=01-0024&_APLICACION="+_A, , , , d['01-0024'], , , , , , ],
