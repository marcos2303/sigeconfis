...
<table width="900" class="tblForm">
	...
	<tr>
		...
		<td class="tagForm">* Estado:</td>
		<td>
            <select id="CodEstado" style="width:200px;" onchange="getOptionsSelect(this.value, 'municipio', 'CodMunicipioNac', true, 'CiudadNacimiento');" <?=$disabled_ver?>>
	...
	<tr>
		...
		<td class="tagForm">* Estado:</td>
		<td>
            <select id="CodEstado" style="width:200px;" onchange="getOptionsSelect(this.value, 'municipio', 'CodMunicipioDom', true, 'CiudadDomicilio');" <?=$disabled_ver?>>
	...
	<tr>
		<td class="tagForm">* Municipio:</td>
		<td>
            <select id="CodMunicipio" style="width:200px;" onchange="getOptionsSelect(this.value, 'ciudad', 'CiudadDomicilio', true);" <?=$disabled_ver?>>
