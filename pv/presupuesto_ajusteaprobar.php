...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Ajuste | Aprobar Ajustes</td>
...
//	-------------------------------------------------------------------------------
$MAXLIMIT=30;
include "presupuesto_ajusteaprobar2.php";
$ano=date("Y");
...
include "presupuesto_ajusteaprobarcontenido.php";
$registros=$rows;
if($registros!=0){ 
for($i=0; $i<$registros; $i++){
   ...
   if($field['TAjuste']=='DI'){$tAjuste='Disminuci&oacute;n';}else{$tAjuste='Incremento';}
   ...
   $id = $field['CAjuste'].'-'.$field['TAjuste'].'-'.$field['CPresupuesto'];
  echo "
