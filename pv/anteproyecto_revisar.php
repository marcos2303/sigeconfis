...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Revisi&oacute;n Anteproyecto</td>
...
$MAXLIMIT=30;
echo "
<form name='frmentrada' action='anteproyecto_revisar.php?limite=0' method='POST'>";
...
<table width="900" class="tblBotones">
  <tr>
	...
	echo"<input type='hidden' name='registros' id='registros' value='$registros'/>
	     <input type='hidden' name='regresar' id='regresar' value='anteproyecto_revisar'/>" ;
   ...
   ?> 
	...
	<input name="btRevisado" type="submit" class="btLista" id="btRevisado" value="Revisar" onclick="cargarRevisado(this.form, 'anteproyecto_revisarantp.php');"/>
