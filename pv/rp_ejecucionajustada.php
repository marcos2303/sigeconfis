...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Ejecuci&oacute;n Presupuestaria Ajustada</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='rp_ejecucionajustada.php?limit=0' method='POST'>";
...
<tr>
 ...
 <td>
  ...
  <input type='text' name='fejercicio' id='fejercicio' size='2' maxlength='4' $dejercicio value='$fejercicio' style='text-align:right;' />
  </td>
</tr>
<tr>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarReportePresupuestoEjecucionAjustada(this.form);'></center>
...
<center>
<iframe name="rp_ejecucionajustada" id="rp_ejecucionajustada" style="border:solid 1px #CDCDCD; width:1000px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>