...
<tr>
  <td class="titulo">Proyecto de Presupuesto</td>
...
if(mysql_num_rows($qry)!=0){
		...
		if(($fielDet['partida']!=00) and (($cont1==0) or ($pCapturada!=$fielDet['partida']))){
	         ...
	         if(mysql_num_rows($qryP)!=0){
		       ...
		       echo "<tr class='trListaBody6'>
		         ...
		         <td align='right'><input type='text' style='text-align:right' size='12' maxlength='12' class='inputP' id='partida' name='partida' value='$montoP' readonly/>Bs.F</td>         
	           </tr>";
		    }
		 }
		 //////////////////////////////////////////////////////////////////
		 ...
		 if(($fielDet['partida']!=00) and (($cont2==0) or ($gCapturada!=$fielDet['generica']) or ($pCapturada2!=$fielDet['partida']))){
	       ...
	       if(mysql_num_rows($qryP)){
			 ...
			 echo "<tr class='trListaBody5'>
		         ...
		         <td align='center'>".$fieldP['Estado']."</td>
		         <td align='center'>".$fieldP['tipo']."</td>
		         <td align='right'><input type='text' size='12' style='text-align:right' maxlength='12' class='inputG' id='generica' name='generica' value='$montoG' readonly/>Bs.F</td>         
	             </tr>";
		   }
	     }
		 //////////////////////////////////////////////////////////////////////////////////////
		 ...
		 if($fielDet['partida']!=00){
		  ...
		  echo "<tr class='trListaBody'>
		        ...
		        <td align='right'><input type='text' size='12' style='text-align:right' class='montoA' maxlength='12' id='$codigo_partida|$codigo_generica' name='".$fielDet['IdAnteProyectoDet']."' value='$montoTotal' onchange='sumarPartidaVer3(this.value, this.id)'; onfocus='obtener(this.value);' readonly/>Bs.F</td>         
	     </tr>";
	 }
  ...
  echo"<input type='text' style='text-align:right' class='inputT' id='totalAnt' name='totalAnt' size='12' value='$totalSumado' readonly/>Bs.F</b></td>
		   </tr>";
//	------------------------------------------------------------------------------------------------------------
//	------------------------------------------------------------------------------------------------------------
$rows=(int)$rows;
...
<tr><td></td>
	...
	<td><input name="dias" type="text" id="dias" size="6" maxlength="3" style="text-align:right" value="<?=$dif2?>" readonly/> d&iacute;as.</td>
	<td colspan="2"></td>
</tr>
<tr><td></td></tr>
</table>
	...
	<tr>
	  ...
	  <td width="521" ><input name="totalAnteproyecto" type="text" id="totalAnteproyecto" style="text-align:right" size="20" maxlength="15" value="<?=$totalAnt?>" readonly/>Bs.F</td>
	</tr>
	<tr><td></td>
