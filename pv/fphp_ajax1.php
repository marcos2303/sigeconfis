...
if ($_POST['modulo']=="APLICACIONES") {
	...
	if ($_POST['accion']=="GUARDAR") {		
		...
		$sql="SELECT * FROM pv_sector WHERE Cod_sector='$codigo' OR Descripcion='$descripcion'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
		else {
			//	INSERTO EL NUEVO REGISTRO
			$sql="INSERT INTO pv_sector VALUES ('$codigo', '".$descripcion."')";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		}
	}
	elseif ($_POST['accion']=="ACTUALIZAR") {
		//	CONSULTO SI EL NUEVO REGISTRO EXISTE
		$sql="SELECT * FROM pv_sector WHERE Descripcion='".$descripcion."' AND Cod_sector<>'$codigo'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
		else {
			//	ACTUALIZO REGISTRO
			$sql="UPDATE pv_sector SET Descripcion='$descripcion' WHERE Cod_sector='$codigo'";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		}
	}
...
elseif ($_POST['modulo']=="ORGANISMOS") {
	...
	if ($_POST['accion']=="GUARDAR") {		
		...
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
			...
			//	INSERTO EL NUEVO REGISTRO
			$sql="INSERT INTO mastorganismos VALUES ('$codigo', '$descripcion', '".$_POST['codpersona']."', '$descripcionc', '$rep', '".$_POST['docr']."', '".$_POST['www']."', '".$_POST['docf']."', '$fecha', '$dir', '".$_POST['ciudad']."', '".$_POST['tel1']."', '".$_POST['tel2']."', '".$_POST['tel3']."', '".$_POST['fax1']."', '".$_POST['fax2']."', '".$_POST['logo']."', '".$_POST['status']."', '".$_POST['nreg']."', '".$_POST['treg']."', '".$_SESSION['USUARIO_ACTUAL']."', '$ahora')";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		}
	}
	elseif ($_POST['accion']=="ACTUALIZAR") {
...
elseif ($_POST['modulo']=="GRUPOOCUPACIONAL") {
	...
	if ($_POST['accion']=="GUARDAR") {		
		//	CONSULTO SI EL NUEVO REGISTRO EXISTE
		$sql="SELECT * FROM rh_grupoocupacional WHERE GrupoOcup='$descripcion'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
		else {
			$codigo=getCodigo("rh_grupoocupacional", "CodGrupOcup", 3);
			//	INSERTO EL NUEVO REGISTRO
...
elseif ($_POST['modulo']=="SERIEOCUPACIONAL") {
	...
	if ($_POST['accion']=="GUARDAR") {		
		//	CONSULTO SI EL NUEVO REGISTRO EXISTE
		$sql="SELECT * FROM rh_serieocupacional WHERE (SerieOcup='$descripcion' AND CodGrupOcup='".$_POST['grupo']."')";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
		else {
			$codigo=getCodigo("rh_serieocupacional", "CodSerieOcup", 3);
			//	INSERTO EL NUEVO REGISTRO
...
elseif ($_POST['modulo']=="NIVELESCARGO") {
	...
	if ($_POST['accion']=="GUARDAR") {		
		...
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
			...
			$codigo=getSecuencia("CodNivelClase", "CodTipoCargo", "rh_nivelclasecargo", $_POST['tipocargo']);
			//	INSERTO EL NUEVO REGISTRO
...
elseif ($_POST['modulo']=="CARGOS") {
	...
	if ($_POST['accion']=="GUARDAR") {		
		//	CONSULTO SI EL NUEVO REGISTRO EXISTE
		$sql="SELECT * FROM rh_puestos WHERE (CodGrupOcup='".$_POST['grupo']."' AND CodSerieOcup='".$_POST['serie']."' AND CodTipoCargo='".$_POST['tipocargo']."' AND CodNivelClase='".$_POST['nivelcargo']."')";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
		else {
			...
			//	INSERTO EL NUEVO REGISTRO
			$sql="INSERT INTO rh_puestos (CodCargo, CodGrupOcup, CodSerieOcup, CodTipoCargo, CodNivelClase, NivelSalarial, DescripCargo, CategoriaCargo, Grado, Estado, Plantilla, DescGenerica, UltimoUsuario, UltimaFecha) VALUES ('$codigo', '".$_POST['grupo']."', '".$_POST['serie']."', '".$_POST['tipocargo']."', '".$_POST['nivelcargo']."', '".$_POST['sueldo']."', '".utf8_decode($descripcion)."', '".$_POST['ttra']."', '".$_POST['gcargo']."', '".$_POST['status']."', '$plantilla_competencias', '".utf8_decode($descripcion_generica)."', '".$_SESSION['USUARIO_ACTUAL']."', '$ahora')";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		}
		echo $error.":".$codigo;
	}
	elseif ($_POST['accion']=="ACTUALIZAR") {
		//	CONSULTO SI EL NUEVO REGISTRO EXISTE
		$sql="SELECT * FROM rh_puestos WHERE (CodGrupOcup='".$_POST['grupo']."' AND CodSerieOcup='".$_POST['serie']."' AND CodTipoCargo='".$_POST['tipocargo']."' AND CodNivelClase='".$_POST['nivelcargo']."') AND CodCargo<>'".$_POST['codigo']."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
		else {
			//	INSERTO EL NUEVO REGISTRO
			$sql="UPDATE rh_puestos SET CodGrupOcup='".$_POST['grupo']."', CodSerieOcup='".$_POST['serie']."', CodTipoCargo='".$_POST['tipocargo']."', CodNivelClase='".$_POST['nivelcargo']."', NivelSalarial='".$_POST['sueldo']."', DescripCargo='".utf8_decode($descripcion)."', CategoriaCargo='".$_POST['ttra']."', Grado='".$_POST['gcargo']."', Estado='".$_POST['status']."', Plantilla='$plantilla_competencias', DescGenerica='".utf8_decode($descripcion_generica)."', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodCargo='".$_POST['codigo']."'";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		}
		echo $error;
	}
	...
	elseif ($_POST['accion']=="CARGOREPORTA") {
		//	CONSULTO SI EL REGISTRO EXISTE
		$sql="SELECT * FROM rh_cargoreporta WHERE CodCargo='".$_POST['cargo']."' AND CargoReporta='".$_POST['cargoreporta']."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="YA SE INGRESO ESTE CARGO";
			...
			$sql="INSERT INTO rh_cargoreporta (CodCargo, Secuencia, CargoReporta, UltimoUsuario, UltimaFecha) VALUES ('".$_POST['cargo']."', '$secuencia', '".$_POST['cargoreporta']."', '".$_SESSION['USUARIO_ACTUAL']."', '$ahora')";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		}
		echo $error;
	}
...
elseif ($_POST['modulo']=="EMPLEADOS") {
	...
	if ($_POST['accion']=="GUARDAR") {
		...
		if ($rows!=0)	$error="NRO. DE DOCUMENTO EXISTENTE";
			...
			$sql="INSERT INTO mastempleado (CodEmpleado, CodPersona, CodTipoTrabajador, CodMotivoCes, CodTipoPago, CodPerfil, CodCargo, CodDependencia, CodOrganismo, Fingreso, SueldoActual, CodTipoNom, Fegreso, Estado, ObsCese, UltimoUsuario, UltimaFecha) VALUES ('$codempleado', '$codpersona', '".$_POST['ttra']."', '".$_POST['tcese']."', '".$_POST['tpago']."', '".$_POST['pnom']."', '".$_POST['cargo']."', '".$_POST['dependencia']."', '".$_POST['organismo']."', '".$fingreso."', '".$sueldo."', '".$_POST['tnom']."', '".$fcese."', '".$_POST['sittra']."', '".$_POST['explicacion']."', '".$_SESSION['USUARIO_ACTUAL']."', '$ahora')";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			...
			$sql="INSERT INTO rh_empleadonivelacion (CodPersona, Secuencia, CodOrganismo, CodDependencia, CodCargo, CodTipoNom, Responsable, Estado, UltimoUsuario, UltimaFecha) VALUES ('".$codpersona."', '".$secuencia."', '".$organismo."', '".$dependencia."', '".$cargo."', '".$tnom."', '".$_SESSION["CODPERSONA_ACTUAL"]."', '".$sittra."', '".$_SESSION['USUARIO_ACTUAL']."', '$ahora')";
			$query=mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($_POST['accion']=="ACTUALIZAR") {
		...
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
			...
			$query=mysql_query($sql) or die ($sql.mysql_error());
			if (($sittra!=$hsittra) || ($tpago!=$htpago) || ($ttra!=$httra)) {
				//	INSERTO EL HISTORIAL
...
elseif ($_POST['modulo']=="FAMILIARES") {
	...
	if ($_POST['accion']=="NUEVO") {
		//	CONSULTO SI EL NUEVO REGISTRO EXISTE
		$sql="SELECT * FROM rh_cargafamiliar WHERE CodPersona='".$_POST['persona']."' AND Ndocumento='".$_POST['ndoc']."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
		else {
	...
	elseif ($_POST['accion']=="ACTUALIZAR") {
		//	CONSULTO SI EL NUEVO REGISTRO EXISTE
		$sql="SELECT * FROM rh_cargafamiliar WHERE Ndocumento='".$_POST['ndoc']."' AND CodSecuencia<>'".$_POST['registro']."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
		else {
...
elseif ($_POST['modulo']=="CESTUDIO") {
	...
	if ($_POST['accion']=="GUARDAR") {		
		...
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
			...
			//	INSERTO EL NUEVO REGISTRO
			$sql="INSERT INTO rh_centrosestudios VALUES ('$codigo', '$descripcion', '$ubicacion', '".$_SESSION['USUARIO_ACTUAL']."', '$ahora')";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		}
	}
	elseif ($_POST['accion']=="ACTUALIZAR") {
		...
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
			...
			//	ACTUALIZO REGISTRO
			$sql="UPDATE rh_centrosestudios SET Descripcion='$descripcion', Ubicacion='$ubicacion', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodCentroEstudio='".$_POST['codigo']."'";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		}
	}
	elseif ($_POST['accion']=="ELIMINAR") {
...
elseif ($_POST['modulo']=="ESTUDIO") {
	...
	elseif ($_POST['accion']=="ACTUALIZAR") {
		$sql="UPDATE rh_empleado_instruccion SET CodGradoInstruccion='".$_POST['grado']."', Area='".$_POST['area']."', CodProfesion='".$_POST['profesion']."', Nivel='".$_POST['nivel']."', CodCentroEstudio='".$_POST['codcentro']."', FechaDesde='".$fdesde."', FechaHasta='".$fhasta."', Colegiatura='".$_POST['colegiatura']."', NroColegiatura='".$_POST['ncolegiatura']."', Observaciones='".$_POST['observaciones']."', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='".$ahora."' WHERE CodPersona='".$_POST['persona']."' AND Secuencia='".$_POST['secuencia']."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());		
	}
...
elseif ($_POST['modulo']=="INSTRUCCION_CURSOS") {
	...
	if ($_POST['accion']=="GUARDAR") {
		...
		$sql="INSERT INTO rh_empleado_cursos (CodPersona, Secuencia, CodCurso, TipoCurso, CodCentroEstudio, FechaDesde, FechaHasta, TotalHoras, AniosVigencia, Observaciones, FlagInstitucional, UltimoUsuario, UltimaFecha) VALUES ('".$_POST['persona']."', '".$secuencia."', '".$_POST['codcurso']."', '".$_POST['tcurso']."', '".$_POST['codcentro']."', '".$fdesde."', '".$fhasta."', '".$_POST['horas']."', '".$_POST['anios']."', '".$_POST['observaciones']."', '".$_POST['flag']."', '".$_SESSION['USUARIO_ACTUAL']."', '$ahora')";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		echo 0;
	}
	elseif ($_POST['accion']=="ACTUALIZAR") {
		$sql="UPDATE rh_empleado_cursos SET CodCurso='".$_POST['codcurso']."', TipoCurso='".$_POST['tcurso']."', CodCentroEstudio='".$_POST['codcentro']."', FechaDesde='".$fdesde."', FechaHasta='".$fhasta."', TotalHoras='".$_POST['horas']."', AniosVigencia='".$_POST['anios']."', Observaciones='".$_POST['observaciones']."', FlagInstitucional='".$_POST['flag']."', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodPersona='".$_POST['persona']."' AND Secuencia='".$_POST['secuencia']."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());		
	}
	echo $error;
}
...
//////////////////////////////////////////////////////////////
/////////////// *****  MODULO ANTEPROYECTO ******/////////////
elseif($_POST['modulo']=="ANTEPROYECTO") {
    connect();
	if($_POST["accion"]=="ANULAR") {
		$error="";
		$sql="SELECT Estado FROM pv_antepresupuesto WHERE CodAnteproyecto='$codigo'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		if($rows!=0){
		  $field=mysql_fetch_array($query);
		...
		}else{ $error="NO SE PUEDE ANULAR ANTEPROYECTO";}
		if($error==""){
			////***** ACTUALIZAR ESTADO DEL ANTEPROYECTO ****///////////
			$sql="UPDATE pv_antepresupuesto SET Estado='$status', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodAnteproyecto='".$codigo."'";
			$query=mysql_query($sql) or die ($sql.mysql_error());
		} else echo $error;
	}
	elseif ($_POST["accion"]=="APROBAR"){
		   ////***** ACTUALIZAR ESTADO DEL ANTEPROYECTO ****///////////
		   $sql="UPDATE pv_antepresupuesto SET Estado='AP', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodAnteproyecto='".$codigo."'";
		   $query=mysql_query($sql) or die ($sql.mysql_error());
	}
	elseif ($_POST["accion"]=="RECHAZAR") {
		  ////***** ACTUALIZAR ESTADO DEL ANTEPROYECTO ****///////////
		$sql="UPDATE pv_antepresupuesto SET Estado='AN', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodAnteproyecto='".$codigo."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
	}elseif ($_POST["accion"]=="REVISAR"){
	   $sql="UPDATE pv_antepresupuesto SET Estado='RV', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodAnteproyecto='".$codigo."'";
	   $query=mysql_query($sql) or die ($sql.mysql_error());
	}elseif ($_POST["accion"]=="GENERAR"){
       $sql="UPDATE pv_antepresupuesto SET Estado='GE', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodAnteproyecto='".$codigo."'";
	   $qry=mysql_query($sql) or die ($sql.mysql_error());
	   $sql2="UPDATE pv_antepresupuestodet SET Estado='GE', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodAnteproyecto='".$codigo."'";
...
elseif ($_POST['modulo']=="PERMISOS") {
	...
	if ($_POST["accion"]=="GUARDAR") {
		...
		//	INSERTO EL NUEVO REGISTRO
		$sql="INSERT INTO rh_permisos VALUES ('$correlativo', '".$_POST['codempleado']."', '$secuencia', '$ahora', '".$_POST['tfalta']."', '".$_POST['tpermiso']."', '".$fdesde."', '".$fhasta."', '".$hdesde."', '".$hhasta."', '".$_POST['periodo']."', '".$_POST['observaciones']."', '".$_POST['remunerado']."', '".$_POST['justificativo']."', '".$_POST['codaprueba']."', '', '', '".$_POST['status']."', '".$_SESSION['USUARIO_ACTUAL']."', '$ahora')";
		$query=mysql_query($sql) or die ($sql.mysql_error());
	}
	elseif ($_POST["accion"]=="ACTUALIZAR") {
		//	INSERTO EL NUEVO REGISTRO
		$sql="UPDATE rh_permisos SET TipoFalta='".$_POST['tfalta']."', TipoPermiso='".$_POST['tpermiso']."', FechaDesde='".$fdesde."', FechaHasta='".$fhasta."', HoraDesde='".$hdesde."', HoraHasta='".$hhasta."', PeriodoContable='".$_POST['periodo']."', ObsMotivo='".$_POST['observaciones']."', FlagRemunerado='".$_POST['remunerado']."', FlagJustificativo='".$_POST['justificativo']."', Aprobador='".$_POST['codaprueba']."', Estado='".$_POST['status']."', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodPermiso='".$_POST['codigo']."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
	}
	...
	elseif ($_POST["accion"]=="APROBAR") {
		//	ACTUALIZO
		$sql="UPDATE rh_permisos SET FlagRemunerado='".$_POST['remunerado']."', FlagJustificativo='".$_POST['justificativo']."', FechaAprobado='$ahora', Estado='".$_POST['status']."', ObsAprobado='".$_POST['obsaprobado']."', UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha='$ahora' WHERE CodPermiso='".$_POST['codigo']."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
	}
	elseif ($_POST["accion"]=="RECHAZAR") {
		//	ACTUALIZO
...
//  DATOS GENERALES
elseif($_POST['modulo']=="DATOSGENERALES"){
connect();
ahora==date("Y-m-d H:i:s");
list($dia,$mes,$annio)=SPLIT('[/.-]', $_POST['finicio']);$fincio=$annio.$mes.$dia;
list($dia,$mes,$annio)=SPLIT('[/.-]', $_POST['ftermino']);$fincio=$annio.$mes.$dia;
list($dia,$mes,$annio)=SPLIT('[/.-]', $_POST['fecha']);$fincio=$annio.$mes.$dia;
//
  if($_POST['accion']=="GUARDAR"){
    $sql="INSERT INTO pv_antepresupuesto(Organismo,EjercicioPpto,FechaAnteproyecto,FechaInicio,FechaFin,TotlalPresupuestado,
	                                     Sector,Programa,Subprograma,Proyecto,Actividad,Estaddo,PreparadoPor,AprobadoPor,
										 UltimoUsuario,UltimaFecha) VALUES ('$organismo',)";
  }
...
elseif ($_POST['modulo']=="NIVELACIONES") {
	...
	if (categoria_ant != categoria) {
		/*
		//	Calculo la fecha de cese que es un dia menos que la nueva fecha de ingreso
		$dia_act = (int) $dia;
		$mes_act = (int) $mes;
		$anio_act = (int) $annio;
		$dia_ant = $dia_act - 1;
		...
		if ($dia_ant == 0) { $mes_ant--; $dia_ant = getDiasMes($anio_ant, $mes_ant); }
		if ($mes_ant == 0) { $anio_ant--; $mes_ant = 12; $dia_ant = 31; }
		$fcese = $anio_ant.$mes_ant.$dia_ant;
		*/
		
		//	ACTUALIZO EMPLEADO
		$sql="UPDATE mastempleado SET CodOrganismo='".$organismo."', CodDependencia='".$dependencia."', CodCargo='".$cargo."', CodTipoNom='".$nomina."', SueldoAnterior='".$sueldo_ant."', SueldoActual='".$sueldo."', Estado='A', CodMotivoCes='', Fingreso='".$fecha."', Fegreso='', ObsCese='' WHERE CodPersona='".$codpersona."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
		
	} else {
		//	ACTUALIZO EMPLEADO
		$sql="UPDATE mastempleado SET CodOrganismo='".$organismo."', CodDependencia='".$dependencia."', CodCargo='".$cargo."', CodTipoNom='".$nomina."', SueldoAnterior='".$sueldo_ant."', SueldoActual='".$sueldo."' WHERE CodPersona='".$codpersona."'";
		$query=mysql_query($sql) or die ($sql.mysql_error());
	}
	...
	$sql="SELECT 
					ren.CodPersona, 
					mmd.Descripcion AS TipoAccion, 
					mp.NomCompleto AS Responsable, 
					me.CodEmpleado, me.Fingreso, 
					me.Fegreso, 
					me.ObsCese, 
					me.Estado, 
					mo.Organismo, 
					...
					rp.DescripCargo, 
					rp.NivelSalarial, 
					mmd2.Descripcion AS CatCargo,
					mtp.TipoPago, 
					rmc.MotivoCese,
					rtt.TipoTrabajador 
			FROM 
					rh_empleadonivelacion ren 
					INNER JOIN mastpersonas mp ON (ren.Responsable=mp.CodPersona) 
					INNER JOIN mastmiscelaneosdet mmd ON (ren.TipoAccion=mmd.CodDetalle AND CodMaestro='TIPOACCION') 
					INNER JOIN mastempleado me ON (ren.CodPersona=me.CodPersona)
					INNER JOIN rh_tipotrabajador rtt ON (me.CodTipoTrabajador=rtt.CodTipoTrabajador) 
					...
					INNER JOIN mastorganismos mo ON (me.CodOrganismo=mo.CodOrganismo) 
					...
					INNER JOIN mastmiscelaneosdet mmd2 ON (rp.CategoriaCargo=mmd2.CodDetalle AND mmd2.CodMaestro='CATCARGO') 
			WHERE 
					ren.CodPersona='".$codpersona."' AND ren.Secuencia='".$secuencia."'";
	$query_datos=mysql_query($sql) or die ($sql.mysql_error());
	if (mysql_num_rows($query_datos)!=0) $field=mysql_fetch_array($query_datos);
	//	-------------------------
...
elseif($_POST['modulo']=="AJUSTE_PRESUPUESTARIO") {
connect();
  if($_POST["accion"]=="ANULAR") {
    $error="";
	 //$id = $field['CAjuste'].'|'.$field['FAjuste'].'|'.$field['Organismo'].'|'.$field['CPresupuesto'];
	 list($cod_ajuste, $fecha_ajuste, $cod_organismo, $cod_presupuesto) = split('[|]', $codigo);
	 ...
	 if($row!=0){
	   ...
	   if($field[0]=="AP"){  
		 ...
		 if($field[0]=="PR"){
		   ...
		   if($field[0]=="AN"){
			 $error="EL AJUSTE SE ENCUENTRA EN ESTADO ANULADO"; 
		   } 
		 }
	   }
...
if($error==""){		
  if($field[0]=="AP"){
	$sql_a = "select 
					...
					a.TipoAjuste
			    from 
				    pv_ajustepresupuestario a 
					inner join pv_ajustepresupuestariodet b on (b.CodAjuste=a.CodAjuste)and(b.Organismo=a.Organismo)and(b.CodPresupuesto=a.CodPresupuesto) 
			   where 
			        a.CodAjuste = '$cod_ajuste' and 
					a.CodPresupuesto = '$cod_presupuesto' and 
					a.Organismo = '$cod_organismo'"; 
	...
	if($row_a!=0){
	  for($i=0; $i<$row_a; $i++){
	   ...
	   /// consulto tabla presupuesto det para obtener el monto de la partida
	   $sql_b= "select 
	                  * 
				   from 
				        pv_presupuestodet 
				   where 
				        CodPresupuesto='".$field_a['CodPresupuesto']."' and 
						Organismo='".$field_a['Organismo']."' and 
						cod_partida='".$field_a['cod_partida']."'";
	   $qry_b= mysql_query($sql_b) or die ($sql_b.mysql_error());
	   $row_b= mysql_num_rows($qry_b);
	   
	   if($row_b!=0){
	     $field_b= mysql_fetch_array($qry_b);
		 if($field_a['TipoAjuste']=='IN'){
		    $monto = $field_b['MontoAjustado'] - $field_a['MontoAjuste']; 
		 }else{
		   $monto = $field_b['MontoAjustado'] + $field_a['MontoAjuste'];
		 }
		 
		 
		 /// realizo update a la tabla pv_presupuestodet especificamente al campo MontoAjustado
	     /// para colocar el monto obtenido a restarle
		 $sql_c="update pv_presupuestodet set MontoAjustado='$monto' where CodPresupuesto='$cod_presupuesto' and cod_partida='".$field_b['cod_partida']."'";
		 $qry_c= mysql_query($sql_c) or die ($sql_c.mysql_error());
		 
		 /// realizo update a la tabla pv_ajustepresupuestariodet al campo Estado
		 $sql_d="update pv_ajustepresupuestariodet set Estado='$status' where CodPresupuesto='$cod_presupuesto' and CodAjuste='$cod_ajuste' and Organismo='$cod_organismo'";
...
/// REALIZO UPDATE A LA TABLA PV_AJUSTEPRESUPUESTARIO
$sql_e= "update 
               pv_ajustepresupuestario 
			set 
			   Estado='$status' 
