...
/// -----------------------------------------------------------------------------
///       *********************  MOSTAR REPORTE  EJECUCION PRESUPUESTARIA 
function cargarReportePresupuestoEjecucionAjustada(form){
  if((form.chknpresupuesto.checked)||(form.chkejercicio.checked)){ 
    ...
    var pagina_mostrar="rp_ejecucionajustadapdf.php?filtro="+filtro+"&filtro2="+filtro2+"&Organismo="+Organismo+"&EjercicioPpto="+EjercicioPpto+"&Periodo="+Periodo+"&fp_hasta="+fp_hasta+"&CodPresupuesto="+CodPresupuesto;
        form.target = "rp_ejecucionajustada";				
				cargarPagina(form, pagina_mostrar);
  }else{
    alert('Ingrese el numero del presupuesto o el periodo de ejecucion....');
	//document.getElementById("rp_PresupuestoIncrementado").style.display=false;
