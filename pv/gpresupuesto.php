<?php 
/// SOLO PARA AJUSTE DE PRESUPUESTO
 $year=date("Y");
...
/// ------------------------------------------------------
if($_POST['fPeriodo']!="") $periodo = date("Y-m",strtotime($_POST['fPeriodo']));
...
$montoAj = $_POST['partida_preDMA']; echo $montoAj;
$montoAj = cambioFormato($montoAj);
$s_ajdet = "update 
                  pv_ajustepresupuestariodet
			   set
			      MontoAjuste = '$montoAj',
