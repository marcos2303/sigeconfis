...
<td align="right">
		<input name="btVer" type="button" class="btLista" id="btVer" value="Ver" onclick="cargarOpcion(this.form, 'presupuesto_ajustever02.php', 'BLANK', 'height=500, width=950, left=200, top=200, resizable=no');" /> 
		...
		<input name="btAprobar" type="button" class="btLista" id="btAprobar" value="Aprobar" onclick="cargarAprobarAjuste(this.form,'presupuesto_ajusteaprobar3.php');"/>
...
<table width="900" class="tblLista">
  <tr class="trListaHead">
   ...
   <th width="50" scope="col">Tipo Ajuste</th>
