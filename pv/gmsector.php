...
for($i=0; $i<$rows ; $i++){
 ...
 $montoCausado = 0; $montoReintegro = 0;
 $montoPagado = 0;  $montoAjusteP = 0; $montoAjusteN = 0;
...
if($mes=='01'){   
	...
	$montoPptoAjustado = $fieldet['MontoAprobado'] + $montoReintegro + $montoIncremento - $montoDisminucion; /// MONTO PRESUPUESTO AJUSTADO
	$montoDisponPresupuestaria = $montoPptoAjustado - $montoCompromiso; /// MONTO DISPONIBILIDAD PRESUPUESTAERIA
	$montoDisponFinanciera = (($montoP - $montoP) + $montoPptoAjustado) - $montoPagado; /// MONTO DISPONIBILIDAD FINANCIERA
   ...
   /// MONTO AJUSTE
	...
	$montoPptoAjustado = ($f_ejecucionPresup['DispPresupuestaria'] + $montoReintegro + $montoIncremento) - $montoDisminucion; 
	/// MONTO DISPONIBILIDAD PRESUPUESTAERIA
	$montoDisponPresupuestaria = $montoPptoAjustado - $montoCompromiso; 
	/// MONTO DISPONIBILIDAD FINANCIERA
	$montoDisponFinanciera = (($f_ejecucionPresup['DispFinanciera'] - $f_ejecucionPresup['DispPresupuestaria']) + $montoPptoAjustado) - $montoPagado; 
	$montoVariacion = $montoDisponFinanciera - $montoDisponPresupuestaria; /// MONTO VARIACION
