...
<tr>
	<td class="titulo">Generar Anteproyecto</td>
	<td align="right"><a class="cerrar" href="framemain.php">[cerrar]</a></td>
</tr>
</table><hr width="100%" color="#333333" />
<?php
include "gmsector.php";
echo"<input type='hidden' id='regresar' name='regresar' value='anteproyecto_generar'/>";
//////////*************** MUESTRO LOS FILTROS ***********////////////////////////////
...
<td align="right">
	...
	<input name="btGenerar" type="button" class="btLista" id="btGenerar" value="Generar" onclick="cargarGenerar(this.form,'anteproyecto_generarantp.php');"/>
