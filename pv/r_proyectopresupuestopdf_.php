...
function Header(){
	...
	$this->SetXY(20, 10); $this->Cell(120, 5,utf8_decode( 'Contraloría del Estado Delta Amacuro'), 0, 0, 'L');
	                      $this->Cell(10,5,'Fecha:',0,0,'');$this->Cell(10,5,date('d/m/Y'),0,1,'');
	$this->SetXY(20, 15); $this->Cell(120, 5, utf8_decode('Dirección de Presupuesto'), 0, 0, 'L');
	...
	$this->Cell(47, 10, utf8_decode('Descripción de Proyecto'), 0, 0, 'C'); $this->Cell(10, 10, $PeriodoEjecucion, 0, 1, 'C');
...
if($rcon!=0){//$pdf=new PDF_MC_Table();
//$pdf->Open(); Cabecera($pdf);
//	Cuerpo
...
$sqlDet="SELECT cod_partida,MontoPresupuestado,
		  ...
		  WHERE CodAnteproyecto='".$fcon['CodAnteproyecto']."' 
