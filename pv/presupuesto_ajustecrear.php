...
<tr>
 <td class="titulo">Ajuste | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="<?=$regresar?>.php?accion=GuardarAjuste" method="post" onsubmit="return verificarDatos(this,'Guardar')" >
<? 
...
<tr>
 ...
 <td width="181"><input name="fresolucion" id="fresolucion" type="text" size="8" maxlength="10" style="text-align:right" />*<i>(dd-mm-aaaa)</i></td>
</tr>
<tr>
 <td width="112"></td>
 ...
 <td width="181"><input name="fgaceta" id="fgaceta" type="text" size="8" maxlength="10" style="text-align:right" />*<i>(dd-mm-aaaa)</i></td>
...
<td class="tagForm">F. Ajuste:</td><? $fcreacion=date("d-m-Y"); $fperiodo=date("Y-m");?>
 <td><input type="text" id="fAjuste" name="fAjuste" size="8" maxlength="10" value="<?=$fcreacion?>" /></td>
</tr>
<tr>
   <td width="122"></td>
   ...
   <td colspan="2"><select id="montivoAjuste" name="motivoAjuste">
			 ...
			 for($b=0; $b<$r_motajus; $b++){
				...
				echo"<option value='".$f_motajus['CodDetalle']."'>".$f_motajus['Descripcion']."</option>";
			 }
			 ?>
             </select>*</td>
</tr>
...
<tr>
  ...
  <td width="180"><input id="fperiodo" name="fperiodo" type="text" size="8" maxlength="8" style="text-align:right" value="<?=$fperiodo?>" />*<i>(aaaa-mm)</i></td>
</tr>
<tr><td height="2"></td></tr>
</table>
...
<tr class="trListaHead">
 ...
 <th width="115" scope="col">Monto Ajustar</th>
</tr>
<?
//------------------------------------------------------------------------------------------------------------
...
if (formulario.nresolucion.value.length <1) {
 alert("Introduzca el Número de Resolución.");
...
if (!allValid) { 
 alert("Introduzca el Número de Resolución correcta en el campo \"Nro. Resolución\"."); 
 formulario.nresolucion.focus(); 
 return (false); 
} 
...
if (formulario.fresolucion.value.length <1) {
 alert("Introduzca la Fecha de Resolución.");
...
if (!allValid) { 
 alert("Introduzca la Fecha de Resolución correcta en el campo \"F. Resolución\"."); 
 formulario.fresolucion.focus(); 
 return (false); 
} 
