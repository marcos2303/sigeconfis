...
function Cabecera($pdf) {
	...
	$qry=mysql_query("SELECT Sector,Programa,SubPrograma,Proyecto,Actividad,Organismo,CodPresupuesto,UnidadEjecutora 
	                    FROM pv_presupuesto 
					   WHERE CodPresupuesto='".$_POST['fnpresupuesto']."' or 
					         EjercicioPpto = '".$_POST['fejercicio']."'") or die ($sql.mysql_error());
	...
	$pdf->Cell(140, 10, 'Ejecución Presupuestaria', 0, 1, 'C');	
	$pdf->SetFont('Arial', '', 7);
	...
	$pdf->Cell(1, 1);
	$pdf->Cell(18, 3, 'PAR GE ESP SE', 1, 0, 'C', 1);
	$pdf->Cell(80, 3, 'DENOMINACION', 1, 0, 'C', 1);
	$pdf->Cell(20, 3, 'MONTO AJUSTADO.', 1, 0, 'C', 1);
	$pdf->Cell(20, 3, 'MONTO PAGADO', 1, 0, 'C', 1);
	$pdf->Cell(20, 3, 'DISP. PRESUP.', 1, 0, 'C', 1);
	$pdf->Cell(20, 3, '% EJECUCION', 1, 0, 'C', 1);
	$pdf->Cell(20, 3, 'DISP. FINAN.', 1, 1, 'C', 1);
