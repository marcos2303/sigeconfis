...
?>		</td>
		<td align="right">
<input name="btVer" type="button" class="btLista" id="btVer" value="Ver" onclick="cargarOpcion(this.form, 'r_proyectopresupuestover.php', 'BLANK', 'height=500, width=950, left=200, top=200, resizable=no');" /> <input type="button" class="btLista" id="btImprimir" name="btImprimir" value="Imprimir" onclick="cargarOpcion(this.form, 'r_proyectopresupuestopdf.php', 'BLANK', 'height=800, width=800, left=200, top=70, resizable=yes');"/>
     </td>
  </tr>
</table>
