...
$_SESSION["MYSQL_HOST"]="192.168.5.5";
$_SESSION["MYSQL_USER"]="root";
$_SESSION["MYSQL_CLAVE"]="54redsxz";
$_SESSION["MYSQL_BD"]="siaceda";
//	----------------------
			...
			if ($rows_admin!=0) {
				...
				while ($field_conceptos = mysql_fetch_array($query_conceptos)) {
					...
					if (mysql_num_rows($query_permisos) != 0) {
						...
						$_SESSION['permisos'][$field_conceptos['Concepto']] = $field_permisos['FlagMostrar'];
						...
						$_SESSION['permisos'][$field_conceptos['Concepto']] = 'N';
					}
				}
